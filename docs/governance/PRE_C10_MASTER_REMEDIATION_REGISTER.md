...
5. Preserve the 85/85 screenshot-ledger pass, the new coaching-subset v4 pass (`20 / 20`), language-constitution pass, responsive pass, and runtime-reliability pass on subsequent edits.
6. Keep extending this register until every user-observed and agent-observed PRE-C10 item is explicitly dispositioned.