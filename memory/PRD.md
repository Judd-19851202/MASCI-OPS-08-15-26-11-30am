...
- **13.31AC · PLATFORM ASSET TAXONOMY, CLASSIFICATION & SOURCE-OF-TRUTH CERTIFICATION (READ-ONLY · 2026-06-13)** — Discovered **10 incompatible asset classification systems** coexisting: equipment_master.category (28) · preop_equipment_type (13) · type (2) · company (15 dirty spellings) · fleet_status.unit_kind (only truck/trailer) · fleet_defects.category (12 · naming collision) · pm_templates.asset_type (unconstrained) · safety_equipment_issuances.items[].item_type (3) · equipment_inspections.equipment_type (5) · asset_transfers.equipment_type (1 · unused). **One motor grader appears simultaneously under 5 different names. Platform contradicts itself.** Canonical taxonomy proposed: 11-class Level 1 + ~60-type Level 2 closed-set + behavior matrix (Reg/Ins/PM/Pre-Op/Map/Renewal/DOT/Inspection/Export) per asset_type. 29 of 30 existing categories map cleanly. **Five-Pillar score: current 4.2/10 · proposed future 9.8/10.** Track 13.31B authorization updated to include Day-0 taxonomy reconciliation (becomes 6-day build). Report: `/app/memory/TRACK_13_31AC_PLATFORM_ASSET_TAXONOMY_CLASSIFICATION_SOURCE_OF_TRUTH_CERTIFICATION.md`.
