...
| `/admin/login` | Public | `PortalLoginHelp` | `portal-login-help-admin-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/pm/login` | Public | `PortalLoginHelp` | `portal-login-help-pm-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/hr/login` | Public | `PortalLoginHelp` | `portal-login-help-hr-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/safety-portal/login` | Public | `PortalLoginHelp` | `portal-login-help-safety-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/dispatch-portal/login` | Public | `PortalLoginHelp` | `portal-login-help-dispatch-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/shop/login` | Public | `PortalLoginHelp` | `portal-login-help-shop-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/field-leadership/portal/login`, `/leadership/login` | Public | `PortalLoginHelp` | `portal-login-help-leadership-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/operations-actions` | Cross-portal public workflow | `CoachingPanel` | `oa-coaching-panel-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/operations-actions/new` | Cross-portal public workflow | `CoachingPanel` | `oa-coaching-panel-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/operations-actions/:id` | Cross-portal public workflow | `CoachingPanel` | `oa-coaching-panel-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | targeted runtime ledger (`operations_actions_detail`, 10 / 10) | **REPAIRED + RUNTIME CERTIFIED** |
| `/notifications` | Role-aware | `LifecycleGuide` | `lifecycle-guide-toggle-notifications-digest` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/admin/compliance-findings` | Admin | `LifecycleGuide` | `lifecycle-guide-toggle-admin-compliance-findings` | collapsed | No | PASS | N/A (admin page convention remains English-first) | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/hr/incidents` | HR | `LifecycleGuide` | `lifecycle-guide-toggle-hr-incidents` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/pm/crew-compliance` | PM | `LifecycleGuide` | `lifecycle-guide-toggle-pm-crew-compliance` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/dispatch-portal/board` | Dispatch | `LifecycleGuide` | `lifecycle-guide-toggle-dispatch-operational-board` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/trench-safety/excavation/new` | Public | `OshaCoachingBlock` family | `coach-soil-toggle` + current visible `coach-*` triggers | collapsed | **Yes — stop-work / emergency / rated-depth warnings must stay visible outside optional OSHA coaching** | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
| `/incidents/report` | Public | `HelpDrawer` | `incident-report-help-trigger` | collapsed | No | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | v4 runtime ledger | **REPAIRED + RUNTIME CERTIFIED** |
