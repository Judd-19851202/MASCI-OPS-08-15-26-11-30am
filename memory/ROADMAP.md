...
| 6b-d5.2 | 13.31B-D5.2 | Per-canonical-asset_type inspection templates + canonical-driven `equipment_type` dropdown (Paver · Roller · Dozer · Grader · Compactor · Backhoe · each Truck · each Trailer · Light Tower · Generator · Pump · Compressor · Welder) | MED | **NEXT (P0)** — backlog now explicit via `template_status="missing_template"` stamp |
