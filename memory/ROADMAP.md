...
| 6b | 13.31B | **Asset Administration Spine** | MED | **NEXT (P1)** — extend equipment_master schema additively · lifecycle enum · Motive foreign-keys · document vault · Asset Administrator role |
