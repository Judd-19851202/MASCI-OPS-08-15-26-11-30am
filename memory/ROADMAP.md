...
| 13.20     | B     | Read-only Material Movement panel on `PmProjectDetail.jsx` (project-scoped). Consumes Phase A.       | `frontend/src/pages/PmProjectDetail.jsx`                       | 2h  | **NEXT — awaiting operator directive**  |
