...
| 6b | 13.31B | **Asset Administration Spine (REVISED · 5-day additive build)** | LOW-MED | **NEXT (P1)** — 13 schema fields + asset_admin role + op_attachments host_kind="asset" + 2 endpoint extensions + 1 new admin page + 1 existing page extension. NO new collections, NO new workflows. |
