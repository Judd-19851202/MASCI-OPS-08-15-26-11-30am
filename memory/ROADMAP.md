...
| 6b-d5.3 | 13.31B-D5.3 | Frontend render of canonical inspection sections + remove hand-maintained equipment_type dropdown + Asset Admin Missing-Template Backlog panel | LOW-MED | **NEXT (P0)** — backend complete; D5.3 is pure UI surface |
