...
| 13.21     | C     | Dispatch Companion Haul Ledger page + `/api/dispatch/haul-ledger` filter endpoint. Outside MapLibre. | new dispatch page + `backend/routes/dispatch_lifecycle.py` ext | 6h  | **NEXT — awaiting operator directive**  |
