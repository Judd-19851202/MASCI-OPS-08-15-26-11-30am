...
| 6b | 13.31B | **Asset Administration Spine (REVISED scope)** | LOW-MED | **NEXT (P1)** — schema-extension only on equipment_master · lifecycle enum · Motive FKs · document vault via existing operational_attachments · Asset Administrator role · 2 single-endpoint extensions · spine reconciliation. NO new collections, NO new workflows. |
