...
| 6b-d5.1 | 13.31B-D5.1-BUILD | **Pre-Op canonical write stamp + canonical-driven equipment_type dropdown** | MED | **NEXT (P0)** per D5.1 certification — highest-leverage gap closure |
| 6b-d5.2 | 13.31B-D5.2 | Per-canonical-asset_type inspection templates (Paver · Roller · Dozer · Grader · Compactor · Backhoe · each Truck · each Trailer · Light Tower · Generator · Pump · Compressor · Welder) | MED | after D5.1 |
