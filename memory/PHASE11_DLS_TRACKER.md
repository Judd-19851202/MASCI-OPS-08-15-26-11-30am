...
| iter395 | Governance + Notifications + CSV | ⏳ next | `ASSIGNMENT_STUCK`, `WAIT_THRESHOLD_EXCEEDED`, `BREAKDOWN_ACTIVE` detectors; 3 CSV endpoints; cross-portal natural continuity tiles. |
