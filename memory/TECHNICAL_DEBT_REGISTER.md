...
| TD-22.1c2-C01 | FastAPI `@app.on_event` deprecation — 51 startup + 1 shutdown handlers should migrate to `lifespan` context manager | **C** — Architecture Debt (progressing) | Backend team | P2 | Tracks 22.1D · 22.1E · 22.1F · 22.1G · 22.1H · 22.1I · 22.1J · 22.1K | **FOUNDATION CLOSED · CUTOVER 54.00% COMPLETE** (2026-07-04 · Tracks 22.1D through 22.1H delivered · Track 22.1H migrated 5 email-capable scheduler handlers into `LIFECYCLE_STEPS.email-scheduler` with all 5 bytecode fingerprints preserved AND closed a pre-existing `_start_safety_digest_cron` double-registration defect · 27/50 unique handlers migrated · on_startup runtime count 51 → 23 · unique callables per boot 51 → 50 · 263/263 lock envelope · remaining 23 queued into Tracks 22.1I / 22.1J / 22.1K with per-track bytecode-fingerprint proof · migration progress live at `GET /api/admin/platform/status.migrated_pct`) |
