...
| TD-22.1c2-C01 | FastAPI `@app.on_event` deprecation — 51 startup + 1 shutdown handlers should migrate to `lifespan` context manager | **C** — Architecture Debt (near-complete) | Backend team | P2 | Tracks 22.1D · 22.1E · 22.1F · 22.1G · 22.1H · 22.1I · 22.1I.1 · 22.1J · 22.1K · 22.1L | **FOUNDATION CLOSED · CUTOVER 98.00% COMPLETE** (2026-07-04 · Tracks 22.1D through 22.1J delivered · Track 22.1J migrated `_iter453_6_flip_ready_flag` into `LIFECYCLE_STEPS.readiness` and introduced the phase-3 readiness-last invariant in `orchestrated_lifespan` · 49/50 unique handlers migrated · on_startup 51 → 1 (only `_startup` from routes.command_center remains, explicitly excluded with owner + target track 22.1L) · migration progress live at `GET /api/admin/platform/status.migrated_pct` = 98.00%) |
