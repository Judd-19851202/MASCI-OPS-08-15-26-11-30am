...
| TD-22.1c2-C01 | FastAPI `@app.on_event` deprecation — 51 startup + 1 shutdown handlers should migrate to `lifespan` context manager | **C** — Architecture Debt (near-complete) | Backend team | P2 | Tracks 22.1D · 22.1E · 22.1F · 22.1G · 22.1H · 22.1I · 22.1I.1 · 22.1J · 22.1K · 22.1L | **FOUNDATION CLOSED · CUTOVER 94.00% COMPLETE** (2026-07-04 · Tracks 22.1D through 22.1I delivered · Track 22.1I migrated 20 misc-bootstrap handlers into `LIFECYCLE_STEPS.misc-bootstrap` · 47/50 unique handlers migrated · on_startup 51 → 3 (only `_startup` from routes.command_center + `_start_backup_scheduler` + `_iter453_6_flip_ready_flag` remain, each explicitly excluded with owner + target track) · 278/278 lock envelope · migration progress live at `GET /api/admin/platform/status.migrated_pct` = 94.00%) |
