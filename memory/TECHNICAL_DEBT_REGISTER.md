...
| TD-21.2E-C01 | Follow-up defense-in-depth: canonicalize 72 non-`TEST_` payload literals across 36 test files so the Track 20.6B in-code gate is sufficient on its own. Inventory: `memory/track_21_2e/NON_TEST_PAYLOAD_INVENTORY.json`. | **C** — Existing Tech Debt | Backend / Test | P1 | 21.2E-1 | **OPEN** (queued behind closeout review) |
