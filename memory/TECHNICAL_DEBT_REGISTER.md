...
| TD-21.2E-C01 | Follow-up defense-in-depth: canonicalize 72 non-`TEST_` payload literals across 36 test files. | **C** | Backend / Test | P1 | 21.2E-1 | **CLOSED** (2026-07-04 · Track 21.2E-1 idempotent canonicalizer rewrote 59 literals · 13 duplicates safely skipped · 0 residual non-TEST_ payloads · `test_track_21_2e_1_canonicalization.py` 6/6 green) |
