...
| TD-21.2-C05 | 168 env vars referenced via `os.environ.get(x, default)` are not declared in `backend/.env`. All have safe defaults; no runtime failure. Documentation debt only. | **C** — Documentation Debt | Backend / Ops | P3 | 21.2z | **OPEN** |
