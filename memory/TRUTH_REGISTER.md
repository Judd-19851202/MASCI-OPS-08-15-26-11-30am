...
| TR-0005 | Status canonical dictionary does not exist | MEDIUM | FOCP P8 | ACTIVE | 5+ heterogeneous backend `STATUSES` constants identified (operational_constraint, document_expirations, fleet DVIR, …) without unified vocabulary — verified 2026-06-02 |
