...
| **UXS-2c** | Full chrome on shared `<PortalShell>` (search + bell + switcher + sign out) | UXS-2 | YES | ✅ **CLOSED 2026-06-14** — see `TRACK_14_0_UXS_REBUILD_ONE_MASCI_PLATFORM.md`. The 4 hubs on PortalShell now match Admin/Shop/FL chrome element-for-element. |
