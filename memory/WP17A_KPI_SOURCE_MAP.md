...
| WP-17A Production Governance Package | production release validation | `/api/admin/wp17a/kpi-dictionary`, `/api/admin/wp17a/reconciliation`, `/api/admin/wp17a/certification`, `/api/admin/wp17a/deployment-package` | live deployed backend build | production currently still on pre-WP-17A build when validated |
