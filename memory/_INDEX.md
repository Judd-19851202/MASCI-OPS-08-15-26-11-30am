...
| `PLATFORM_FORM_LAYOUT_BLEED_AUDIT.md` | **V.5 P0** · iPad field-bleed investigation · 84 unsafe Tailwind occurrences mapped · root cause `sm:` breakpoint + `gap-3/4` | ✅ ⛔ |
| `PLATFORM_FORM_GRID_FIX_CERTIFICATION.md` | **V.5 P0** · 69 mechanical replacements + new shared `FormGrid.jsx` · zero business-logic change · regression suite green | ✅ ⛔ |
| `IPAD_LAYOUT_VALIDATION_REPORT.md` | **V.5 P0** · visual evidence at 390 / 820 / 1180 px viewports · DR / Meeting / Equipment / QA-QC bleed eliminated | ✅ ⛔ |
| `FORM_SPACING_DOCTRINE.md` | **V.5 P0 doctrine** · canonical `grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4` · responsive contract · variant matrix · binding on every form on the platform | ✅ ⛔ |
