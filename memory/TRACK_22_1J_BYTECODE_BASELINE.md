# TRACK 22.1J · Bytecode Baseline

## New fingerprint added
| Handler | SHA-256 | Locked in track |
|---|---|---|
| `_iter453_6_flip_ready_flag` | `3ad0b42c02c53519565c03606ae0024b903a6db7c71c42578e406541e89a8fc4` | **22.1J** |

## Rationale
Readiness is safety-critical. A silent edit could delay or falsify the ready signal (`app.state.ready`) — the platform could accept public writes prematurely, or refuse them permanently. The SHA-256 lock catches any body change in CI.

## Storage
- `memory/BYTECODE_FINGERPRINTS/_iter453_6_flip_ready_flag.sha256.txt`
- `memory/BYTECODE_FINGERPRINTS/INDEX.json` (`_iter453_6_flip_ready_flag` key added)

## Complete locked set (post-22.1J · 7 fingerprints)
| Handler | SHA-256 |
|---|---|
...
`verify_locked_bytecode(app)` post-migration:
```json
{"checked": 7, "ok_count": 7, "drift_count": 0, "missing_count": 0, "clean": true}
```
