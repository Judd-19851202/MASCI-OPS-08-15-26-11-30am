...
* Generated: 2026-07-26 19:29:46 UTC
* Scan duration: 296 ms
...
* **Baselined** (previously approved): 21
...
* `pages/FieldLeadershipView.jsx:32` · ad-hoc canApprove variable · `if (!getFlToken() && !isAdmin() && !getPmToken()) {`
