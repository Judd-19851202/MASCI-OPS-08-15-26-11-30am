...
const FIELD_LESSONS = [
  ...
  },
  {
    ...
    why: "MASCI Job Hazard Analyses are built before work begins by the Safety Department, Project Managers, and leadership — based on scope of work, site conditions, traffic control (MOT), environmental factors, and known project hazards. This way hazards are identified and controlled BEFORE crews step onto the job. A properly built JHA is one of the strongest tools we have to prevent incidents and eliminate guesswork in the field.",
    duration: "~6 min",
    steps: [
      "Crews do NOT build JHAs. JHAs are job-specific documents prepared in advance by the Safety Department, Project Managers, and senior leadership before any crew shows up.",
      "Each JHA covers: identified hazards across the project, hazard locations tied to station numbers, required controls for each hazard, environmental and site-specific risks, MOT (traffic control) hazards, and equipment/operational hazards.",
      "Every JHA package includes two documents: (1) the JHA DOCUMENT — full list of hazards, locations by station, required controls and safe practices; (2) the HAZARD WORKSHEET — hazard type and threat level, exact location, required controls, and additional notes where needed.",
      "Before starting work: review the JHA, understand the hazards specific to your work area, and follow every listed control.",
    ...
    tips: [
      "The JHA exists so every crew member understands the risks BEFORE they encounter them. Use it, follow it, and speak up if something doesn't match what's documented.",
