...
export const LESSON_TRANSLATIONS_ES = {
  ...
  "field-06-jha": {
    ...
    steps_es: [
      ...
      "Llene proyecto, líder de cuadrilla, título de la tarea, descripción y miembros que harán la tarea.",
      "Marque cada artículo de EPP Requerido y cada Permiso Requerido (espacio confinado, trabajo en caliente, excavación, etc.).",
      "Liste las Herramientas y Equipo necesarios.",
      "Para cada Paso de la tarea: describa qué hace la cuadrilla → liste Peligros Potenciales → liste Controles / Prácticas Seguras. Agregue tantos pasos como necesite.",
      "Información de emergencia: Autoridad para Suspender Trabajo reconocida, Hospital/ER más cercano, # de Contacto de Emergencia.",
      "Cada miembro firma para confirmar entendimiento. El capataz aprueba. Envíe.",
    ],
    tips_es: [
      "Esto NO es una lista que llena en su escritorio. Recorra la tarea físicamente antes de escribirla.",
      "Autoridad para Suspender el Trabajo: cada miembro la tiene. Sin preguntas, sin disciplina — si no se siente bien, pare.",
    ],
    cheatSheet_es: [
      "Específico de la tarea, antes de comenzar el trabajo.",
      "Paso → Peligros → Controles por cada paso.",
