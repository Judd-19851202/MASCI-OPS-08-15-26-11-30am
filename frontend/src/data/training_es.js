...
export const LESSON_TRANSLATIONS_ES = {
  ...
  "field-05-jha": {
    title_es: "Lección 5 — Análisis de Peligros del Trabajo (JHA)",
    why_es: "Los JHAs de MASCI se preparan antes de que comience el trabajo, por el Departamento de Seguridad, los Gerentes de Proyecto y el liderazgo — basados en el alcance del trabajo, condiciones del sitio, control de tráfico (MOT), factores ambientales y peligros conocidos del proyecto. Así los peligros se identifican y controlan ANTES de que la cuadrilla pise el sitio. Un JHA bien hecho es una de las mejores herramientas que tenemos para prevenir incidentes y eliminar la improvisación en el campo.",
    steps_es: [
      "Las cuadrillas NO crean JHAs. Los JHAs son documentos específicos del proyecto, preparados con anticipación por Seguridad, los Gerentes de Proyecto y el liderazgo, antes de que llegue cualquier cuadrilla.",
      "Cada JHA cubre: peligros identificados en todo el proyecto, ubicaciones de peligros por número de estación, controles requeridos para cada peligro, riesgos ambientales y específicos del sitio, peligros de MOT (control de tráfico), y peligros del equipo y de la operación.",
      "Cada paquete JHA viene con dos documentos: (1) el DOCUMENTO JHA — lista completa de peligros, ubicaciones por estación, controles requeridos y prácticas seguras; (2) la HOJA DE PELIGROS — tipo de peligro y nivel de amenaza, ubicación exacta, controles requeridos y notas adicionales donde se necesiten.",
      "Antes de comenzar el trabajo: revise el JHA, entienda los peligros específicos de su área de trabajo, y siga cada control listado.",
    ...
    tips_es: [
      "El JHA existe para que cada miembro de la cuadrilla entienda los riesgos ANTES de encontrarlos. Úselo, sígalo, y hable si algo no coincide con lo documentado.",
      "Autoridad para Suspender el Trabajo: cada miembro la tiene. Sin preguntas, sin disciplina — si las condiciones en el sitio no coinciden con el JHA, pare.",
    ],
    cheatSheet_es: [
      "Los JHAs los prepara Seguridad / PM / Liderazgo — no la cuadrilla.",
      "Dos documentos por trabajo: JHA + Hoja de Peligros (con números de estación).",
  ...
  "pm-06-posters-jha": {
    title_es: "Lección 6 — Carteles del Sitio + Planes JHA",
    why_es: "Los Carteles del Sitio son folletos imprimibles que pegan dentro de los tráileres — con código QR para que las cuadrillas escaneen desde cualquier teléfono. Los Planes JHA son PDFs por trabajo que la oficina sube para que los capataces lean el Plan de Peligros antes de comenzar.",
    steps_es: [
      "Panel de Carteles del Sitio (Portal de Gestión → Carteles). Tres carteles: Hoja de Referencia, Cartel de Cajas de Zanja, Cartel de Planes JHA.",
      "Vista previa de cualquier cartel en nueva pestaña. Imprímalo. Péguelo dentro de cada tráiler de trabajo activo.",
      "Admin de Planes JHA: suba un PDF por trabajo activo — arrastre o clic para elegir. Máximo 10 MB por PDF.",
    ...
    tips_es: [
      ...
      "Si el Plan JHA de un trabajo no está subido, los capataces no pueden verlo. Ponga recordatorio en calendario: suba antes del Día 1 de cada nuevo trabajo.",
    ],
    cheatSheet_es: [
      "Carteles → imprimir → pegar en tráiler.",
      "PDF JHA → subido por trabajo → legible sin conexión en teléfonos.",
    ],
  },
  ...
  "admin-01-platform-overview": {
    ...
    steps_es: [
      ...
      "Paneles principales bajo Admin: Tableros (cumplimiento), Listas Maestras (Trabajos/Empleados/Proveedores/Equipo/Partes), Formularios (Ver y Correo), Ruteo de Correos, Carteles, Admin JHA, Admin Cajas de Zanja, Gerentes de Proyecto, Recuperación del Sistema.",
