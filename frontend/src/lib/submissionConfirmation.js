const WORKFLOW_RULES = {
  ...
  "asset-transfer": {
    familyLabel: "Equipment Operations",
    familyMeta: "Asset transfer workflow",
    title: "Asset Transfer Filed Successfully",
    description: "This transfer request is on file and routed for dispatch review.",
    documentTypeLabel: "Transfer #",
    routedTo: ["Dispatch", "Receiving Project Team"],
    whatHappensNext: [
      "Dispatch reviews the transfer request and coordinates the move.",
      "The receiving team marks the transfer received when the unit arrives.",
    ],
    expectedProcessingStatus: "Filed and waiting for dispatch review",
    returnToPortal: { label: "Return to Portal", to: "/asset-transfers" },
  },
  "operational-constraint": {
    familyLabel: "Project Controls",
    familyMeta: "Operational constraint workflow",
    title: "Constraint Filed Successfully",
    description: "This operational blocker is on file and visible to the project team.",
    documentTypeLabel: "Constraint #",
    routedTo: ["Assigned Project Manager", "Operations Leadership"],
    whatHappensNext: [
      "The project team can review the blocker, owner, and field impact from the shared constraint list.",
      "Follow-up notes and resolution updates stay attached to this same constraint record.",
    ],
    expectedProcessingStatus: "Filed and open for project follow-up",
    startAnother: { label: "Start Another", to: "/constraints/new" },
    returnToPortal: { label: "Return to Portal", to: "/constraints" },
  },
  "fuel-lube-visit": {
    familyLabel: "Shop Operations",
    familyMeta: "Fuel and lube visit workflow",
    title: "Fuel / Lube Visit Submitted Successfully",
    description: "This service visit is on file and tied to the affected unit history.",
    documentTypeLabel: "Fuel / Lube Visit #",
    routedTo: ["Shop Operations", "Unit History"],
    whatHappensNext: [
      "Each serviced unit keeps this visit in its operating history.",
      "Any issue lines create shop follow-up records automatically.",
    ],
    expectedProcessingStatus: "Filed in shop records",
    returnToPortal: { label: "Return to Portal", to: "/shop" },
  },
  "service-truck-reconciliation": {
    familyLabel: "Shop Operations",
    familyMeta: "Service truck reconciliation workflow",
    title: "Service Truck Reconciliation Filed Successfully",
    description: "This service truck reconciliation is on file for shop accountability.",
    documentTypeLabel: "Reconciliation #",
    routedTo: ["Shop Operations"],
    whatHappensNext: [
      "Shop can review the record against linked fuel and lube visits.",
      "Variance notes stay attached to this same reconciliation record.",
    ],
    expectedProcessingStatus: "Filed in shop records",
    returnToPortal: { label: "Return to Portal", to: "/shop" },
  },
  "transport-carrier-invite": {
    familyLabel: "Transportation Compliance",
    familyMeta: "External carrier packet workflow",
    title: "Carrier Packet Submitted Successfully",
    description: "This carrier packet is on file and routed into MASCI Transportation review.",
    documentTypeLabel: "Carrier Packet #",
    routedTo: ["Transportation Compliance Center"],
    whatHappensNext: [
      "Transportation reviews the submitted packet and follows up if corrections are needed.",
      "The carrier receives the next status update from the same invite workflow.",
    ],
    expectedProcessingStatus: "Filed and pending transportation review",
    returnToPortal: { label: "Return to MASCI", to: "/" },
  },
  "jha-acknowledgement": {
    familyLabel: "Safety",
    familyMeta: "JHA acknowledgement workflow",
    title: "Hazard Plan Acknowledgement Filed Successfully",
    description: "Your acknowledgement is on file for this exact Hazard Plan revision.",
    documentTypeLabel: "Acknowledgement #",
    routedTo: ["Project leadership", "Safety compliance record"],
    whatHappensNext: [
      "Project leadership can verify that this specific Hazard Plan revision was acknowledged before work proceeds.",
      "Your acknowledgement remains attached to the filed plan revision in the compliance history.",
    ],
    expectedProcessingStatus: "Filed in the acknowledgement ledger",
    startAnother: { label: "Review Another Plan", to: "/jha" },
    returnToPortal: { label: "Return to JHA Library", to: "/jha" },
  },
  excavation: {
...
export function buildSubmissionConfirmation(input = {}) {
  ...
  return {
    ...
    viewFiledCopy: input.viewFiledCopy || null,
    printFiledCopy: input.printFiledCopy || null,
