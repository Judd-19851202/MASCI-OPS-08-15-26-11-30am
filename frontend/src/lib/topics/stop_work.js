...
export const TOPICS_STOP_WORK = [
  {
    ...
    references_cited:
      "OSHA Stop Work Authority (multiple programs — General Duty Clause) · ANSI/ASSP Z10 Section 5.1.4 · MASCI Stop Work Authority Policy · Track 15.47 Workplace Violence Workflow",
    action_items:
