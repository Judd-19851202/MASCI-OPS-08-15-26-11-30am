...
const ES = {
  ...
  "Manage project pay items, governed mappings, lookaheads, lifecycle, and crew review within your assigned project scope.": "Administra partidas del proyecto, asignaciones gobernadas, ventanas de planificación, ciclo de vida y revisión de cuadrillas dentro del alcance de tus proyectos asignados.",
  "Assigned project scope": "Alcance del proyecto asignado",
  "Project pay items stay project-specific, enterprise work types stay admin-governed, and governed mappings connect the two without letting Daily Reports overwrite schedule truth.": "Las partidas del proyecto siguen siendo específicas del proyecto, los tipos de trabajo empresariales siguen gobernados por administración y las asignaciones gobernadas conectan ambos sin permitir que los Reportes Diarios sobrescriban la verdad del cronograma.",
  "Project pay items": "Partidas del proyecto",
  "These remain customer / contract truth for this project only.": "Estas siguen siendo la verdad del cliente / contrato solo para este proyecto.",
  "No project pay items entered yet.": "Todavía no se han ingresado partidas del proyecto.",
  "Governed mappings": "Asignaciones gobernadas",
  "Select one project pay item and connect it to the right enterprise work type. AI never approves these silently.": "Selecciona una partida del proyecto y conéctala con el tipo de trabajo empresarial correcto. La IA nunca las aprueba en silencio.",
  "Choose pay item": "Elegir partida",
  "Choose work type": "Elegir tipo de trabajo",
  "Approve mapping": "Aprobar asignación",
  "Two-week lookahead": "Ventana de planificación de dos semanas",
  "Field actuals may inform this view, but PM-published planning remains the schedule authority.": "Los datos reales de campo pueden informar esta vista, pero la planificación publicada por PM sigue siendo la autoridad del cronograma.",
  "Lifecycle & archive": "Ciclo de vida y archivo",
  "Archive never deletes history. Every record remains searchable under the same permission model.": "Archivar nunca elimina el historial. Cada registro sigue siendo buscable bajo el mismo modelo de permisos.",
  "Archive project": "Archivar proyecto",
  "Restore project": "Restaurar proyecto",
  "Current state": "Estado actual",
  "Crew intelligence": "Inteligencia de cuadrillas",
  "Observed crew patterns are suggestions only until a human confirms them.": "Los patrones observados de cuadrillas son solo sugerencias hasta que una persona los confirme.",
  "Crew leader suggestion": "Sugerencia de líder de cuadrilla",
  "Observed": "Observado",
  "Confidence": "Confianza",
  "Confirm": "Confirmar",
  "Defer": "Diferir",
  "Reject": "Rechazar",
  "Recent governed work blocks": "Bloques de trabajo gobernados recientes",
  "This ledger stays additive: Daily Reports remain the source for field actuals.": "Este libro mayor sigue siendo aditivo: los Reportes Diarios siguen siendo la fuente para los datos reales de campo.",
  "No governed work blocks yet. Daily Reports will add them automatically when field work is entered.": "Todavía no hay bloques de trabajo gobernados. Los Reportes Diarios los agregarán automáticamente cuando se ingrese trabajo de campo.",
  "Governed work blocks": "Bloques de trabajo gobernados",
  "The system will preserve today's field entries and build governed work blocks from production, cost-code quantities, crews, equipment, materials, and constraints without replacing the Daily Report.": "El sistema conservará las entradas de campo de hoy y construirá bloques de trabajo gobernados a partir de producción, cantidades por código de costo, cuadrillas, equipos, materiales y restricciones sin reemplazar el Reporte Diario.",
  "Preview blocks": "Bloques en vista previa",
  "Enter production, a cost-code quantity, or report-level resources to preview governed work blocks.": "Ingresa producción, una cantidad por código de costo o recursos a nivel de reporte para ver bloques de trabajo gobernados.",
  "Installed": "Instalado",
  "Crew rows": "Filas de cuadrilla",
  "Equipment rows": "Filas de equipo",
  "Material rows": "Filas de material",
  "Govern enterprise work types, review unresolved mappings, and verify the event contracts behind governed project controls.": "Gobierna tipos de trabajo empresariales, revisa asignaciones sin resolver y verifica los contratos de eventos detrás de los controles del proyecto gobernados.",
  "Run compatibility backfill": "Ejecutar vinculación de compatibilidad",
  "Enterprise work types": "Tipos de trabajo empresariales",
  "These remain admin-governed and are reused across projects.": "Estos siguen gobernados por administración y se reutilizan entre proyectos.",
  "No work types found.": "No se encontraron tipos de trabajo.",
  "No open review items right now.": "No hay elementos abiertos en revisión en este momento.",
  "Event contracts": "Contratos de eventos",
  "Authority": "Autoridad",
  "Producer": "Productor",
  "Create a reusable enterprise work type without touching any project-specific pay item.": "Crea un tipo de trabajo empresarial reutilizable sin tocar ninguna partida específica del proyecto.",
  "Work type saved.": "Tipo de trabajo guardado.",
  "Could not load governed project controls.": "No se pudieron cargar los controles del proyecto gobernados.",
  "Could not save the work type.": "No se pudo guardar el tipo de trabajo.",
  "Compatibility backfill finished.": "La vinculación de compatibilidad terminó.",
  "Could not run the compatibility backfill.": "No se pudo ejecutar la vinculación de compatibilidad.",
  ...
  "modules and shared destinations.": "módulos y destinos compartidos.",
  "Administrative navigation": "Navegación administrativa",
  "Open universal search": "Abrir búsqueda universal",
  "Search everything": "Buscar en toda la plataforma",
  "Operations Control Center": "Centro de Control de Operaciones",
  "OCC operation": "Operación del OCC",
  "Entity": "Entidad",
  "Universal search": "Búsqueda universal",
  "Search pages · operations · projects · employees · equipment…": "Buscar páginas · operaciones · proyectos · empleados · equipos…",
  "Close search": "Cerrar búsqueda",
  "Searching…": "Buscando…",
  "No matches. Try a different search.": "No hay coincidencias. Prueba otra búsqueda.",
  "Page": "Página",
  "open the top match": "abrir la coincidencia principal",
  "Tip: type a page, an operation, a project, or a person.": "Tip: escribe una página, una operación, un proyecto o una persona.",
  "Switch portal": "Cambiar portal",
  "Access": "Acceso",
  "Current": "Actual",
  "Search platform (Cmd+K)": "Buscar en la plataforma (Cmd+K)",
  "Search": "Buscar",
  "Global Search": "Búsqueda global",
  "Sign in to search": "Inicia sesión para buscar",
  "Global search requires an active portal session.": "La búsqueda global requiere una sesión activa de portal.",
  "Could not load search results. Try again.": "No se pudieron cargar los resultados de búsqueda. Inténtalo de nuevo.",
  "Recent": "Reciente",
  "Clear": "Borrar",
  "Type at least 2 characters to search.": "Escribe al menos 2 caracteres para buscar.",
  "No matches for": "No hay coincidencias para",
  "Scope": "Alcance",
  "Scoped to your role": "Limitado a tu rol",
  "↑↓ navigate": "↑↓ navegar",
  "open": "abrir",
  "close": "cerrar",
  "Notifications · sound muted": "Notificaciones · sonido silenciado",
  "Notifications": "Notificaciones",
  "upload queued": "carga en cola",
  "uploads queued": "cargas en cola",
  "Mark all read": "Marcar todo como leído",
  "Sound": "Sonido",
  "On": "Activado",
  "Snooze 1h": "Pausar 1 h",
  "Snooze 8h": "Pausar 8 h",
  "Mute notification sounds on this device": "Silenciar sonidos de notificación en este dispositivo",
  "Mute": "Silenciar",
  "Sound muted until": "Sonido silenciado hasta",
  "Notifications still arrive silently.": "Las notificaciones seguirán llegando en silencio.",
  "You're all caught up.": "Estás al día.",
  "Action": "Acción",
  "Source module": "Módulo fuente",
  "Local device time": "Hora local del dispositivo",
  "Task": "Tarea",
  "View all tasks": "Ver todas las tareas",
  "Breadcrumb": "Ruta de navegación",
  "Admin OS": "Sistema Administrativo",
  "Source": "Fuente",
  "Drill": "Ir",
  "Executive Overview": "Resumen ejecutivo",
  "Corrective Action": "Acción Correctiva",
  "Corrective Actions Due Today": "Acciones Correctivas que Vencen Hoy",
  "No corrective actions are dated due today and no daily reports for today are awaiting your verify.": "No hay acciones correctivas con vencimiento hoy y ningún Reporte Diario de hoy espera tu verificación.",
  "Corrective Actions Due": "Acciones Correctivas por Vencer",
  "Corrective actions open": "Acciones correctivas abiertas",
  "Time to corrective action (days)": "Tiempo hasta la acción correctiva (días)",
  "Unlinked location feeds": "Fuentes de ubicación sin vincular",
  "Location feed coverage": "Cobertura de la fuente de ubicación",
  "Location feed": "Fuente de ubicación",
  "The location feed validates later — it does not replace the driver.": "La fuente de ubicación valida después; no reemplaza al conductor.",
  "Driver Link Review": "Revisión de Vinculación de Conductores",
  "Driver Matching": "Vinculación de Conductores",
  "Open Corrective Actions": "Acciones Correctivas Abiertas",
  "Admin": "Administración",
  "Administration": "Administración",
  "Project Management": "Gestión de Proyectos",
  "Admin Operating System": "Sistema Operativo de Administración",
  "One governed command surface for platform posture, domain ownership, and the next safe action.":
    "Una superficie de mando gobernada para la postura de la plataforma, la propiedad de dominios y la siguiente acción segura.",
  "Download a Markdown snapshot of the current platform trust state":
    "Descargar una instantánea en Markdown del estado actual de confianza de la plataforma",
  "Export snapshot": "Exportar instantánea",
  "Portal mission": "Misión del portal",
  "Run the platform without hunting for the right domain.": "Opera la plataforma sin tener que buscar el dominio correcto.",
  "Start with posture, open the domain that needs attention, and keep maintenance/governance actions separated from business operations noise.":
    "Comienza con la postura, abre el dominio que necesita atención y mantén las acciones de mantenimiento/gobernanza separadas del ruido de las operaciones de negocio.",
  "Platform posture": "Postura de la plataforma",
  "One or more domains report a critical condition.": "Uno o más dominios reportan una condición crítica.",
  "One or more domains need attention.": "Uno o más dominios necesitan atención.",
  "All wired domains report healthy.": "Todos los dominios conectados reportan estado saludable.",
  "Healthy": "Saludable",
  "Attention": "Atención",
  "Critical": "Crítico",
  "Awaiting signal": "Esperando señal",
  "Total domains": "Total de dominios",
  "Platform command center.": "Centro de mando de la plataforma.",
  "Review system health, investigate risks, and open the right operational area from one screen. Every metric is read from a live platform endpoint — cards without a live signal are honestly labelled “Awaiting signal”.":
    "Revisa la salud del sistema, investiga riesgos y abre el área operativa correcta desde una sola pantalla. Cada métrica se lee de un endpoint vivo de la plataforma; las tarjetas sin señal viva se etiquetan honestamente como “Esperando señal”.",
  "Search everything with": "Busca todo con",
  "Timestamps display in your local time.": "Las marcas de tiempo se muestran en tu hora local.",
  "Digest Schedule": "Programación del Resumen",
  "Weekly digest recipients · schedule · preview · send.": "Destinatarios del resumen semanal · programación · vista previa · envío.",
  "Dashboard URL": "URL del tablero",
  "Send Now": "Enviar ahora",
  "Digest Preview": "Vista previa del resumen",
  "No preview available.": "No hay vista previa disponible.",
  "Digest settings saved": "La configuración del resumen se guardó correctamente",
  "Integration Center": "Centro de Integraciones",
  "Motive · MaintainX · CSV feeds.": "Motive · MaintainX · fuentes CSV.",
  "Central Integration Layer": "Capa central de integración",
  "Motive · MaintainX · Integration Framework": "Motive · MaintainX · marco de integración",
  "All third-party logic flows through this single layer — Safety, Shop, HR, and Admin portals read from it, never directly from Motive or MaintainX. Set the toggles + paste credentials here once the Motive / MaintainX accounts are provisioned.":
    "Toda la lógica de terceros fluye a través de esta única capa; los portales de Seguridad, Taller, RR. HH. y Administración leen desde aquí, nunca directamente desde Motive o MaintainX. Configura los interruptores y pega las credenciales aquí una vez que las cuentas de Motive / MaintainX estén aprovisionadas.",
  "Operational Health Dashboard": "Tablero de Salud Operativa",
  "Enterprise Governance is the first constitutional module on the shared health framework.":
    "Gobernanza Empresarial es el primer módulo constitucional sobre el marco compartido de salud.",
  "Enterprise Governance": "Gobernanza Empresarial",
  "This dashboard is a read-only consumer of canonical evidence. Unknown is shown whenever evidence is missing or stale.":
    "Este tablero es un consumidor de solo lectura de evidencia canónica. Se muestra “Desconocido” cuando falta evidencia o está desactualizada.",
  "Primary route": "Ruta principal",
  "Constitutional Certification": "Certificación constitucional",
  "Current Operational Health": "Salud operativa actual",
  "Exact RED drivers": "Impulsores exactos en ROJO",
  "Amber watchlist": "Lista de observación ámbar",
  "Deep links": "Enlaces directos",
  "Filter by KPI, evidence source, producer, or root cause…": "Filtra por KPI, fuente de evidencia, responsable o causa raíz…",
  "Loading enterprise governance evidence…": "Cargando evidencia de gobernanza empresarial…",
  "No KPI cards match the current filter.": "Ninguna tarjeta KPI coincide con el filtro actual.",
  "Pinned": "Fijado",
  "Bulk Replace": "Reemplazo masivo",
  "Archive is empty — nothing to restore.": "El archivo está vacío; no hay nada para restaurar.",
  "Soft-deleted rows · auto-purged after {days} days. Click": "Filas eliminadas suavemente · se purgan automáticamente después de {days} días. Haz clic",
  "to restore.": "para restaurar.",
  "Search {entity}…": "Buscar {entity}…",
  "Restore to active list": "Restaurar a la lista activa",
  "Save changes": "Guardar cambios",
  "Cancel edit": "Cancelar edición",
  "Edit row": "Editar fila",
  "Delete row": "Eliminar fila",
  "Saved {count} photos as {file}": "Se guardaron {count} fotos como {file}",
  "Could not build zip — try saving photos individually": "No se pudo crear el zip; intenta guardar las fotos individualmente",
  "Save all ({count}) as zip": "Guardar todas ({count}) como zip",
  "Project Operations": "Operaciones del Proyecto",
  "Live operations · jobs · timeline · risk.": "Operaciones en vivo · trabajos · cronología · riesgo.",
  "Field Coordination": "Coordinación de Campo",
  "Today's signal across your projects.": "La señal de hoy en tus proyectos.",
  "Field Leadership": "Liderazgo de Campo",
  "Field activity across your assigned projects.": "Actividad de campo en tus proyectos asignados.",
  "Financials & Cost": "Finanzas y Costos",
  "Pending approvals · receipts · spend.": "Aprobaciones pendientes · recibos · gasto.",
  "Compliance & Risk": "Cumplimiento y Riesgo",
  "Incidents, QA/QC, crew compliance.": "Incidentes, QA/QC, cumplimiento de cuadrillas.",
  "Document Control": "Control Documental",
  "Crew documentation across your projects.": "Documentación de cuadrillas en tus proyectos.",
  "System & Communications": "Sistema y Comunicaciones",
  "Action items across all domains.": "Elementos de acción en todos los dominios.",
  "Overview": "Resumen",
  "PM read-only consumption · today's risk picture.": "Consumo PM de solo lectura · panorama de riesgo de hoy.",
  "Jobs": "Trabajos",
  "Jobs assigned to you (read-only).": "Trabajos asignados a ti (solo lectura).",
  "Due Today": "Vence hoy",
  "Items due today across your projects.": "Elementos que vencen hoy en tus proyectos.",
  "Operational Daily Records": "Registros Operativos Diarios",
  "Field production, manpower, progress.": "Producción de campo, mano de obra, progreso.",
  "Operational Intelligence": "Inteligencia Operativa",
  "Three horizons · ODS-backed KPIs · attention.": "Tres horizontes · KPI respaldados por ODS · atención.",
  "Project Health": "Salud del Proyecto",
  "Operational friction by job.": "Fricción operativa por trabajo.",
  "PO Requests": "Solicitudes de OC",
  "Purchase orders, change exposure, budget signals.": "Órdenes de compra, exposición a cambios, señales de presupuesto.",
  "Meetings": "Reuniones",
  "Pre-shift, toolbox, project meetings.": "Preturno, caja de herramientas, reuniones del proyecto.",
  "My Tasks": "Mis Tareas",
  "Approved supplier roster (read-only).": "Lista aprobada de proveedores (solo lectura).",
  "Suppliers": "Proveedores",
  "Equipment Fleet": "Flota de Equipos",
  "Fleet, pre-op, suppliers, people.": "Flota, preoperación, proveedores, personal.",
  "Asset Transfers": "Transferencias de Activos",
  "Equipment movement and lifecycle.": "Movimiento y ciclo de vida del equipo.",
  "People": "Personal",
  "Employee master (read-only).": "Maestro de empleados (solo lectura).",
  "Crew Compliance": "Cumplimiento de Cuadrillas",
  "Crew assignments across your projects.": "Asignaciones de cuadrillas en tus proyectos.",
  "Training Center": "Centro de Capacitación",
  "Training, PPE, CAPA exposure, expirations.": "Capacitación, EPP, exposición CAPA, vencimientos.",
  "Incidents": "Incidentes",
  "Open and recent safety/quality deviations.": "Desviaciones recientes y abiertas de seguridad/calidad.",
  "QA/QC": "QA/QC",
  "Quality records across your projects.": "Registros de calidad en tus proyectos.",
  "JHA Plans": "Planes AST",
  "Job hazard analyses by asset and task.": "Análisis de riesgos de trabajo por activo y tarea.",
  "Trench Safety": "Seguridad de Zanjas",
  "Excavations, assets, repair queue, reports.": "Excavaciones, activos, cola de reparaciones, reportes.",
  "Holds": "Bloqueos",
  "Open holds across your projects.": "Bloqueos abiertos en tus proyectos.",
  "Pre-Op Checks": "Verificaciones Preoperativas",
  "Today's pre-shift checks across your fleet.": "Verificaciones de preturno de hoy en toda tu flota.",
  "Job Photos": "Fotos de Trabajo",
  "Field photos by job and week.": "Fotos de campo por trabajo y semana.",
  "Site Posters": "Carteles de Obra",
  "Printable JHA, trench box, inspection QRs.": "AST imprimibles, cajas de zanja, QR de inspección.",
  "How-to guides and troubleshooting.": "Guías prácticas y solución de problemas.",
  "Change Password": "Cambiar contraseña",
  "Rotate your sign-in credentials.": "Rota tus credenciales de inicio de sesión.",
  ...
  "Safety surfaces now follow the same shell, navigation hierarchy, and glass/grid system as the rest of the platform while keeping operational risk clear.":
    "Las superficies de Seguridad ahora siguen el mismo shell, jerarquía de navegación y sistema de vidrio/cuadrícula que el resto de la plataforma, manteniendo claro el riesgo operativo.",
  "Keep the workforce ready with fewer clicks and clearer operational context.":
  ...
  "Soft-deleted jobs · auto-purged after {days} days. Click": "Trabajos eliminados suavemente · se purgan automáticamente después de {days} días. Haz clic",
  "Soft-deleted units · auto-purged after {days} days. Click": "Unidades eliminadas suavemente · se purgan automáticamente después de {days} días. Haz clic",
  "Search unit, make, model, VIN…": "Buscar unidad, marca, modelo, VIN…",
  "Fleet is empty — click": "La flota está vacía; haz clic en",
  "or": "o",
  "Compliance Export": "Exportación de Cumplimiento",
  "CSV exports for monthly OSHA / DOT review": "Exportaciones CSV para revisión mensual OSHA / DOT",
  "Export All ({count})": "Exportar todo ({count})",
  "Start date": "Fecha de inicio",
  "End date": "Fecha de fin",
  "Refresh counts": "Actualizar conteos",
  "{count} record(s) in range": "{count} registro(s) en el rango",
  "CSVs include every field except photos and signatures. Open in Excel, Google Sheets, or hand to your OSHA / DOT auditor.":
    "Los CSV incluyen todos los campos excepto fotos y firmas. Ábrelos en Excel, Google Sheets o entrégalos a tu auditor OSHA / DOT.",
  "Full Off-Site Backup": "Respaldo completo fuera del sitio",
  "Single .zip · CSVs + JSON + PDFs + photos": "Un solo .zip · CSV + JSON + PDF + fotos",
  "Download Full Backup": "Descargar respaldo completo",
  "One dated .zip covering everything on the system: every safety record (CSVs + raw JSON + PDFs + photos + signatures) across all 6 modules, plus the equipment-unit / JHP-plan / trench-box registries and employees / suppliers seed data. Drop the .zip on your office NAS or shared drive after download. Restore it anytime from the panel below.":
    "Un .zip con fecha que cubre todo el sistema: cada registro de seguridad (CSV + JSON crudo + PDF + fotos + firmas) en los 6 módulos, además de los registros de unidades de equipo / planes JHP / cajas de zanja y los datos semilla de empleados / proveedores. Deja el .zip en tu NAS de oficina o unidad compartida después de descargarlo. Restáuralo en cualquier momento desde el panel de abajo.",
  "Restore from Backup": "Restaurar desde respaldo",
  "Upload a MASCI .zip · rebuilds the entire system": "Sube un .zip de MASCI · reconstruye todo el sistema",
  "Source:": "Fuente:",
  "Upload .zip": "Subir .zip",
  "From R2 archive": "Desde archivo R2",
  "Mode:": "Modo:",
  "Merge (safe)": "Combinar (seguro)",
  "Replace (wipe + restore)": "Reemplazar (borrar + restaurar)",
  "Pick backup .zip": "Elegir respaldo .zip",
  "≤ 500 MB · must be a backup produced by “Download Full Backup”": "≤ 500 MB · debe ser un respaldo producido por “Descargar respaldo completo”",
  "Loading R2 archives…": "Cargando archivos R2…",
  "R2 not configured on this deploy. Cloud archive restore is unavailable.": "R2 no está configurado en este despliegue. La restauración desde archivo en la nube no está disponible.",
  "People Operations": "Operaciones de Personal",
  "Day-to-day employee lifecycle and field accountability.": "Ciclo de vida diario del empleado y responsabilidad en campo.",
  "Time & Payroll": "Tiempo y Nómina",
  "Time verification, payroll variance, expense visibility.": "Verificación de tiempo, variación de nómina, visibilidad de gastos.",
  "Compliance & Records": "Cumplimiento y Registros",
  "Certifications, driver qualification, safety overlap.": "Certificaciones, calificación de conductores, cruce con seguridad.",
  "Guidance": "Guía",
  "Open sign-in help only if you need onboarding or troubleshooting.": "Abra la ayuda de acceso solo si necesita incorporación o solución de problemas.",
  "Operations Actions guide": "Guía de Acciones Operativas",
  "Ownership first, then routing, then escalation.": "Primero la responsabilidad, luego el enrutamiento y luego la escalación.",
  "Integration mapping guide": "Guía de mapeo de integraciones",
  "Approved mapping records": "Registros de mapeo aprobados",
  "Where operators act": "Dónde actúan los operadores",
  "Mapping records live in": "Los registros de mapeo viven en",
  " — they tie MASCI master IDs to external Motive / MaintainX IDs without mutating the governed equipment or employee master records.": " — enlazan los ID maestros de MASCI con los ID externos de Motive / MaintainX sin modificar los registros maestros gobernados de equipos o empleados.",
  "Dispatch reads the live numbers here. Admin manages the mappings at": "Despacho lee aquí los números en vivo. Administración gestiona los mapeos en",
  "Dispatch reads live readiness here while Admin owns the governed mapping records.": "Despacho ve aquí la disponibilidad en vivo mientras Administración mantiene los registros de mapeo gobernados.",
  "Operator guides and supporting documentation.": "Guías operativas y documentación de apoyo.",
  "Overview": "Resumen",
  "Today's HR signal across the field.": "Señal de RR. HH. de hoy en el campo.",
  "Daily Reports": "Reportes Diarios",
  "Read-only HR audit of crew daily reports.": "Auditoría de RR. HH. de solo lectura sobre reportes diarios de cuadrillas.",
  "Employee Lifecycle": "Ciclo de Vida del Empleado",
  "Add, status, offboarding, termination playbook.": "Alta, estado, salida y manual de terminación.",
  "Employee Accountability": "Responsabilidad del Empleado",
  "Per-employee records, history, equipment, clearance.": "Registros por empleado, historial, equipo, autorizaciones.",
  "Incidents": "Incidentes",
  "Read-only OSHA-relevant list · CSV export.": "Lista relevante para OSHA de solo lectura · exportación CSV.",
  "Field Leadership Users": "Usuarios de Liderazgo de Campo",
  "Create, disable, reset passwords for Field Leadership logins.": "Crear, deshabilitar y restablecer contraseñas para inicios de sesión de Liderazgo de Campo.",
  "Field Leadership Records": "Registros de Liderazgo de Campo",
  "Crew docs, coaching, recognition, evaluations.": "Documentos de cuadrilla, coaching, reconocimiento, evaluaciones.",
  "Time Verification": "Verificación de Tiempo",
  "Daily report labor, lunch, payroll cross-check.": "Cruce de mano de obra, almuerzo y nómina del reporte diario.",
  "Payroll Variance": "Variación de Nómina",
  "Reconcile Exact CSV against MASCI hours.": "Conciliar CSV de Exact contra horas de MASCI.",
  "Time Off Requests": "Solicitudes de Tiempo Libre",
  "Vacation, sick, medical, bereavement approvals.": "Aprobaciones de vacaciones, enfermedad, médico y duelo.",
  "Professional Qualifications": "Calificaciones Profesionales",
  "Competent Person + all OSHA / MSHA / trade credentials.": "Persona competente + todas las credenciales OSHA / MSHA / de oficio.",
  "Historical Records Intake": "Ingreso de Registros Históricos",
  "Upload legacy records — HR, Safety, Asset lanes.": "Subir registros heredados: RR. HH., Seguridad y líneas de activos.",
  "Historical Records Queue": "Cola de Registros Históricos",
  "Review, approve, reject staged records.": "Revisar, aprobar y rechazar registros preparados.",
  "Bulk Historical Intake": "Ingreso Histórico Masivo",
  "Many files · one session · classify · approve.": "Muchos archivos · una sesión · clasificar · aprobar.",
  "Incidents & Escalation": "Incidentes y Escalación",
  "Active incidents, near misses, corrective action closure.": "Incidentes activos, casi accidentes y cierre de acciones correctivas.",
  "Incidents & Near Misses": "Incidentes y Casi Accidentes",
  "Severity-tagged review and follow-up.": "Revisión y seguimiento con severidad etiquetada.",
  "Corrective Actions": "Acciones Correctivas",
  "Open, investigate, verify, close out.": "Abrir, investigar, verificar y cerrar.",
  "Tasks & Actions": "Tareas y Acciones",
  "Cross-portal accountability and approvals.": "Responsabilidad y aprobaciones entre portales.",
  "Documents & Training": "Documentos y Capacitación",
  "Library, certifications, accountability, PPE issuance.": "Biblioteca, certificaciones, responsabilidad y entrega de EPP.",
  "Training & Certifications": "Capacitación y Certificaciones",
  "Records, renewals, sign-in sheets.": "Registros, renovaciones y hojas de firma.",
  "Safety Document Library": "Biblioteca de Documentos de Seguridad",
  "OSHA, SDS, EAPs, fall protection.": "OSHA, SDS, EAP, protección contra caídas.",
  "Equipment & PPE Accountability": "Responsabilidad de Equipo y EPP",
  "Issuance, returns, use and care training.": "Entrega, devoluciones y capacitación de uso y cuidado.",
  "Employee Safety Profiles": "Perfiles de Seguridad del Empleado",
  "Per-employee training, incidents, PPE.": "Capacitación por empleado, incidentes y EPP.",
  "Field Records & Plans": "Registros y Planes de Campo",
  "Toolbox talks, site inspections, JHA plans.": "Charlas de seguridad, inspecciones del sitio y planes AST.",
  "Safety Meetings": "Reuniones de Seguridad",
  "Toolbox talks and pre-shift huddles.": "Charlas de seguridad y reuniones previas al turno.",
  "Site Inspections": "Inspecciones del Sitio",
  "Job-site walkthroughs and grading.": "Recorridos y calificación del sitio de trabajo.",
  "JHA / JHP Plans": "Planes AST / JHP",
  "Job hazard analyses and crew sign-offs.": "Análisis de riesgos laborales y firmas de cuadrilla.",
  "Expirations, fire extinguishers, weekly digest, reports.": "Vencimientos, extintores, resumen semanal y reportes.",
  "Fire Extinguishers": "Extintores",
  "Monthly inspections and unit history.": "Inspecciones mensuales e historial de la unidad.",
  "Reports & Exports": "Reportes y Exportaciones",
  "OSHA 300, trend, executive roll-ups.": "OSHA 300, tendencias y resúmenes ejecutivos.",
  "Safety Records Intake": "Ingreso de Registros de Seguridad",
  "Upload legacy safety records for an employee.": "Subir registros de seguridad heredados para un empleado.",
  "Safety Records Queue": "Cola de Registros de Seguridad",
  "Approve or reject staged Safety-lane records.": "Aprobar o rechazar registros preparados del carril de Seguridad.",
  "Training Center & Systems": "Centro de Capacitación y Sistemas",
  "Inspections, topic prep, fleet visibility, and how-to guides.": "Inspecciones, preparación de temas, visibilidad de flota y guías prácticas.",
  "Audits & Inspections": "Auditorías e Inspecciones",
  "Job-site safety inspection review.": "Revisión de inspecciones de seguridad del sitio.",
  "Topic Library": "Biblioteca de Temas",
  "Filter and pack safety topics for prep.": "Filtrar y empaquetar temas de seguridad para preparación.",
  "Trucking · Fleet": "Transporte · Flota",
  "Defects, driver notes, severity context.": "Defectos, notas del conductor y contexto de severidad.",
  "Live Board": "Tablero en Vivo",
  "Haul-board, escalations, breakdowns. Real-time scan.": "Tablero de acarreos, escalaciones y averías. Escaneo en tiempo real.",
  "Haul Board": "Tablero de Acarreos",
  "Five-second silent refresh. Severity-first.": "Actualización silenciosa de cinco segundos. Prioridad a la severidad.",
  "Dispatch Hub": "Centro de Despacho",
  "Operational moments and primary actions.": "Momentos operativos y acciones primarias.",
  "Dispatch Command": "Comando de Despacho",
  "Command Center · live map + assignments.": "Centro de mando · mapa en vivo + asignaciones.",
  "Driver Coordination": "Coordinación de Conductores",
  "Fleet visibility, driver qualifications, MVR windows.": "Visibilidad de flota, calificaciones de conductores y ventanas MVR.",
  "Fleet Visibility": "Visibilidad de Flota",
  "Live asset roster · per-truck status.": "Lista de activos en vivo · estado por camión.",
  "Driver Qualification": "Calificación de Conductores",
  "Eligibility, qualifications, MVR windows.": "Elegibilidad, calificaciones y ventanas MVR.",
  "Company-wide loads, materials, scale-ticket proof.": "Cargas a nivel compañía, materiales y comprobantes de boletos de báscula.",
  ...
  "Company-wide material movement, loads, trucks, and scale-ticket proof. Companion view — the live map remains primary at":
    "Movimiento de materiales a nivel compañía, cargas, camiones y comprobantes de boletos de báscula. Vista complementaria: el mapa en vivo sigue siendo principal en",
  "From": "Desde",
  "To": "Hasta",
  "Project #": "Proyecto #",
  "all": "todos",
  ...
  "verified": "verificado",
  "missing_proof": "prueba_faltante",
  "partial": "parcial",
  "needs_review": "necesita_revisión",
  "derived view across haul_cycles · dispatch_assignments · operational_attachments · daily_reports. Max 90-day window. No fabricated quantities.":
    "vista derivada de haul_cycles · dispatch_assignments · operational_attachments · daily_reports. Ventana máxima de 90 días. Sin cantidades fabricadas.",
  "Loads": "Cargas",
  "Haul cycles": "Ciclos de acarreo",
  "Scale tickets": "Boletos de báscula",
  "Missing proof": "Prueba faltante",
  "Net tons (tickets)": "Toneladas netas (boletos)",
  "DR rows · in": "Filas de RD · entrada",
  "DR rows · out": "Filas de RD · salida",
  "Loading haul ledger…": "Cargando libro de acarreos…",
  "Haul ledger feed unavailable ({error}). No data invented. Retry by changing the date range or clicking Apply.":
    "El feed del libro de acarreos no está disponible ({error}). No se inventaron datos. Intenta cambiando el rango de fechas o haciendo clic en Aplicar.",
  "No haul ledger activity for this range.": "No hay actividad del libro de acarreos en este rango.",
  "Date": "Fecha",
  "Project": "Proyecto",
  "Material": "Material",
  "Driver": "Conductor",
  ...
  "FleetWatcher not connected — ledger is currently based on MASCI daily reports, dispatch haul cycles, and scale-ticket attachments. No accounting, cost, or pay-quantity totals are computed by this surface.":
    "FleetWatcher no está conectado; el libro se basa actualmente en reportes diarios de MASCI, ciclos de acarreo de despacho y adjuntos de boletos de báscula. Esta superficie no calcula totales contables, de costo ni de cantidad pagable.",
  "Field safety and quality checks.": "Verificaciones de seguridad y calidad en campo.",
  "JHAs, trench boxes, trench safety, posters.": "AST, cajas de zanja, seguridad de zanjas, carteles.",
  "Use My Location": "Usar mi ubicación",
  "Tap Use My Location or enter a verified location.": "Toca Usar mi ubicación o ingresa una ubicación verificada.",
  "Tap Use My Location to refresh weather from verified coordinates.": "Toca Usar mi ubicación para actualizar el clima con coordenadas verificadas.",
  "Voice to report": "Voz para el reporte",
  "Hold the mic, speak in any language, and I’ll add English text to Work Performed or Activities.":
    "Mantén presionado el micrófono, habla en cualquier idioma y agregaré texto en inglés a Trabajo Realizado o Actividades.",
  "Activities": "Actividades",
  "FIELD QUANTITY TRACKING": "SEGUIMIENTO DE CANTIDADES DE CAMPO",
  "Assigned project cost codes appear here so crews can log today’s installed quantity against bid quantity.":
    "Los códigos de costo asignados al proyecto aparecen aquí para que las cuadrillas registren la cantidad instalada hoy contra la cantidad ofertada.",
  "Upload delivery tickets, quantity spreadsheets, CEI notes, or other supporting files.":
    "Sube boletos de entrega, hojas de cantidades, notas CEI u otros archivos de respaldo.",
  "AI drafts a summary from what you entered. You stay the source of truth — accept it, regenerate and accept it, or reject it and approve a manual version. This is what your PM will see.":
    "La IA redacta un resumen a partir de lo que ingresaste. Tú sigues siendo la fuente de verdad: acéptalo, regénéralo y acéptalo, o recházalo y aprueba una versión manual. Esto es lo que verá tu PM.",
  "Grounded in the fields you've entered. Before submit, you must accept the AI summary, regenerate and then accept it, or reject it and approve a manual summary.":
    "Basado en los campos que ingresaste. Antes de enviar, debes aceptar el resumen de IA, regenerarlo y luego aceptarlo, o rechazarlo y aprobar un resumen manual.",
  "Submission is blocked until one approved": "El envío está bloqueado hasta que uno sea aprobado",
  "Recipients, schedule, dashboard link, and on-demand send for the weekly safety roll-up. DB values override env defaults.":
    "Destinatarios, programación, enlace del tablero y envío bajo demanda para el resumen semanal de seguridad. Los valores de BD reemplazan los valores predeterminados del entorno.",
  "Enabled": "Habilitado",
  "Disabled": "Deshabilitado",
  "The scheduler will send on the configured day/time. Manual send works too.":
    "El programador enviará en el día/hora configurados. El envío manual también funciona.",
  "The scheduler is paused. Manual send is blocked until you re-enable.":
    "El programador está en pausa. El envío manual está bloqueado hasta que vuelvas a habilitarlo.",
  "Recipients (comma-separated)": "Destinatarios (separados por comas)",
  "{count} recipient(s) configured": "{count} destinatario(s) configurado(s)",
  "Weekday": "Día de la semana",
  "Hour (platform time · scheduler)": "Hora (tiempo de plataforma · programador)",
  "Runs at": "Se ejecuta a las",
  "Admin Profile": "Perfil de Administración",
  "Your profile": "Tu perfil",
  "Manage how you sign in to MASCI on this and other devices.": "Administra cómo inicias sesión en MASCI en este y otros dispositivos.",
  "Your devices": "Tus dispositivos",
  "Directory session required": "Se requiere sesión de directorio",
  "No devices enabled for faster sign-in yet.": "Aún no hay dispositivos habilitados para un inicio de sesión más rápido.",
  "Use the prompt above to enable Face ID / Touch ID / Windows Hello on this device.": "Usa el aviso anterior para habilitar Face ID / Touch ID / Windows Hello en este dispositivo.",
  "Removing a device only stops it from being used to sign in. Your password is unaffected.": "Eliminar un dispositivo solo impide usarlo para iniciar sesión. Tu contraseña no se ve afectada.",
  "Regresar al Admin": "Volver a Administración",
  "Directory session required": "Se requiere sesión de directorio",
  "Hold to speak": "Mantén para hablar",
  "Field quantity tracking": "Seguimiento de cantidades de campo",
  "No assigned project cost codes yet. PM job setup will populate this section.":
    "Aún no hay códigos de costo de proyecto asignados. La configuración del trabajo PM completará esta sección.",
  "file": "archivo",
  "files": "archivos",
  "sent to": "enviado a",
  "Monday": "Lunes",
  ...
  "One-glance executive summary — service health, build version, uptime.": "Resumen ejecutivo de un vistazo — salud del servicio, versión de compilación, tiempo activo.",
  "Service is not reporting.": "El servicio no está reportando.",
  "Operations Control Center": "Centro de Control de Operaciones",
  "The single console for platform maintenance — dry-run, apply, audit.": "La consola única para mantenimiento de la plataforma — simulación, aplicar, auditoría.",
  "Sign in as admin to load OCC status.": "Inicia sesión como administrador para cargar el estado del OCC.",
  "Storage & Recovery": "Almacenamiento y Recuperación",
  "Backups, R2 bucket usage, RPO / RTO posture, restore drills.": "Respaldos, uso del bucket R2, postura RPO / RTO, simulacros de restauración.",
  "Sign in as admin to load recovery snapshot.": "Inicia sesión como administrador para cargar la instantánea de recuperación.",
  "AI Operations": "Operaciones de IA",
  "Provider selection, model routing, gateway posture, failover.": "Selección de proveedor, enrutamiento de modelos, postura de pasarela, conmutación por error.",
  "Sign in as admin to load AI gateway status.": "Inicia sesión como administrador para cargar el estado de la pasarela de IA.",
  "Communications": "Comunicaciones",
  "Email routing, digest scheduler, notification broadcast health.": "Enrutamiento de correo, programación de resúmenes, salud del broadcast de notificaciones.",
  "Sign in as admin to load email routing status.": "Inicia sesión como administrador para cargar el estado del enrutamiento de correo.",
  "Identity & Security": "Identidad y Seguridad",
  "Active sessions, MFA enrollment, portal access, people directory.": "Sesiones activas, inscripción MFA, acceso a portales, directorio de personas.",
  "Sign in as admin to load session inventory.": "Inicia sesión como administrador para cargar el inventario de sesiones.",
  "Governance & Trust": "Gobernanza y Confianza",
  "Governance rules, audit log, compliance findings, deploy readiness.": "Reglas de gobernanza, registro de auditoría, hallazgos de cumplimiento, preparación de despliegue.",
  "Sign in as admin to load governance summary.": "Inicia sesión como administrador para cargar el resumen de gobernanza.",
  "Platform Configuration": "Configuración de la Plataforma",
  "Integration wiring (Motive, Resend, R2), brand, feature flags.": "Cableado de integraciones (Motive, Resend, R2), marca, banderas de funciones.",
  "Sign in as admin to load integration probes.": "Inicia sesión como administrador para cargar las sondas de integración.",
  "Diagnostics": "Diagnósticos",
  "System health probes, database capacity, asset-spine, analytics.": "Sondas de salud del sistema, capacidad de base de datos, columna vertebral de activos, analítica.",
  "Health probe is not responding.": "La sonda de salud no está respondiendo.",
  "Maintenance": "Mantenimiento",
  "Legacy imports, master history, cleanup routines, geofence reconcile.": "Importaciones heredadas, historial maestro, rutinas de limpieza, conciliación de geocercas.",
  "Sign in as admin to load maintenance overview.": "Inicia sesión como administrador para cargar el resumen de mantenimiento.",
  "Last checked (your local time)": "Última verificación (tu hora local)",
  "Equipment & Suppliers": "Equipos y Proveedores",
  "Training & Forms": "Capacitación y Formularios",
  "Compliance & Audits": "Cumplimiento y Auditorías",
  "System & Backups": "Sistema y Respaldos",
  "Governance Health": "Salud de Gobernanza",
  "Operational Language": "Lenguaje Operativo",
  "MaintainX · Read-First": "MaintainX · Leer primero",
  "Asset Mapping": "Mapeo de Activos",
  "Employee Mapping": "Mapeo de Empleados",
  "Mapping Cleanup": "Limpieza de Mapeos",
  "Sync Logs": "Registros de Sincronización",
  "Error Logs": "Registros de Errores",
  "CSV Import / Export": "Importación / Exportación CSV",
  "Mappings Wizard": "Asistente de Mapeos",
  "Geofences": "Geocercas",
  "HEALTHY": "SALUDABLE",
  "NEEDS ATTENTION": "REQUIERE ATENCIÓN",
  "ACTION REQUIRED": "ACCIÓN REQUERIDA",
  "Share Daily Report Form": "Compartir formulario de reporte diario",
  "Anyone with this link can fill out a Daily Job Report from the field.":
    "Cualquiera con este enlace puede completar un Reporte Diario de Trabajo desde el campo.",
  "Field Operations": "Operaciones de Campo",
  "Platform command center.": "Centro de comando de la plataforma.",
  "Cross-portal single-glass view.": "Vista unificada entre portales.",
  "One-page executive summary.": "Resumen ejecutivo de una sola página.",
  "Dashboard": "Tablero",
  "Cross-domain posture · live health.": "Postura entre dominios · salud en vivo.",
  "Platform Tools": "Herramientas de plataforma",
  "Deep tools that support the domains above.": "Herramientas profundas que respaldan los dominios anteriores.",
  "Business Operations": "Operaciones del negocio",
  "Jobs · fleet · safety · people · training.": "Trabajos · flota · seguridad · personal · capacitación.",
  "Command Center": "Centro de mando",
  "P&L": "P&G",
  "Profit-and-loss by job and division.": "Ganancias y pérdidas por trabajo y división.",
  "Jobs & Projects": "Trabajos y proyectos",
  "Every active project · posters · banners.": "Cada proyecto activo · carteles · banners.",
  "Cross-portal daily reports · evidence.": "Reportes diarios entre portales · evidencia.",
  "Fleet & Equipment": "Flota y equipo",
  "Assets · inspections · vendors · drivers.": "Activos · inspecciones · proveedores · conductores.",
  "Dispatch": "Despacho",
  "Transfers · holds · equipment utilization.": "Transferencias · bloqueos · utilización de equipo.",
  "Transportation": "Transporte",
  "Trucks · trailers · driver logs.": "Camiones · remolques · registros de conductor.",
  "Operations Control": "Control de Operaciones",
  "Trust center · maintenance console.": "Centro de confianza · consola de mantenimiento.",
  "Storage & Recovery": "Almacenamiento y Recuperación",
  "Disk · object storage · backups · restore.": "Disco · almacenamiento de objetos · respaldos · restauración.",
  "AI Operations": "Operaciones de IA",
  "Providers · gateways · AI-powered modules.": "Proveedores · pasarelas · módulos impulsados por IA.",
  "Communications": "Comunicaciones",
  "Email routing · providers · digests.": "Enrutamiento de correo · proveedores · resúmenes.",
  "Identity & Security": "Identidad y Seguridad",
  "Sessions · access · audit · protection.": "Sesiones · acceso · auditoría · protección.",
  "Governance & Trust": "Gobernanza y Confianza",
  "Release reviews · deploy readiness · rules.": "Revisiones de liberación · preparación de despliegue · reglas.",
  "Platform Readiness": "Preparación de la Plataforma",
  "Reviews · evidence · blockers.": "Revisiones · evidencia · bloqueos.",
  "Reviews · evidence · blockers": "Revisiones · evidencia · bloqueos",
  "Platform Configuration": "Configuración de la Plataforma",
  "Branding · integrations · AI · version.": "Marca · integraciones · IA · versión.",
  "Diagnostics": "Diagnósticos",
  "System health · scheduler · database.": "Salud del sistema · programador · base de datos.",
  "Maintenance": "Mantenimiento",
  "Every safe operation grouped by domain.": "Cada operación segura agrupada por dominio.",
  "Safety & Compliance": "Seguridad y cumplimiento",
  "Incidents · JHAs · trench · findings.": "Incidentes · AST · zanja · hallazgos.",
  "People & Access": "Personal y acceso",
  "Employees · sessions · terminations.": "Empleados · sesiones · terminaciones.",
  "Training": "Capacitación",
  "Training resources · videos · forms.": "Recursos de capacitación · videos · formularios.",
  "Share Form": "Compartir formulario",
  "Share": "Compartir",
  "Print QR": "Imprimir QR",
  "Preview the form": "Vista previa del formulario",
  "Scan with phone camera": "Escanear con la cámara del teléfono",
  "Fill out today's safety inspection:": "Completa la inspección de seguridad de hoy:",
  "Copied.": "Copiado.",
  "Copy failed — write it down by hand.": "La copia falló — anótalo manualmente.",
  "Pop-up blocked. Allow pop-ups to print the QR poster.": "La ventana emergente fue bloqueada. Permite ventanas emergentes para imprimir el póster QR.",
  "No Daily Report in 3+ days": "Sin Reporte Diario en más de 3 días",
  "open incident(s)": "incidente(s) abiertos",
  "threshold": "umbral",
  "projects with no DR in 3+ days": "proyectos sin RD en más de 3 días",
  "workplace-violence incident(s) in last 90 days": "incidente(s) de violencia laboral en los últimos 90 días",
  "public-interaction incidents in last 30 days": "incidentes de interacción pública en los últimos 30 días",
  "Read-only · attention surface for executives": "Solo lectura · superficie de atención para ejecutivos",
  "Loading executive overview…": "Cargando resumen ejecutivo…",
  "Failed to load executive overview": "No se pudo cargar el resumen ejecutivo",
  "no data": "sin datos",
  "Read-only": "Solo lectura",
  "attention surface": "superficie de atención",
  "Portal mission": "Misión del portal",
  "Give leadership the shortest possible path to risk, not a second analytics maze.": "Dale al liderazgo el camino más corto posible hacia el riesgo, no un segundo laberinto analítico.",
  "Executive views now participate in the same canonical shell while staying intentionally concise, role-appropriate, and operationally clear.": "Las vistas ejecutivas ahora participan en el mismo shell canónico sin dejar de ser concisas, adecuadas al rol y operativamente claras.",
  "Generated": "Generado",
  "Loaded in": "Cargado en",
  "Jobs Requiring Attention": "Trabajos que requieren atención",
  "Active projects flagged by DR cadence + open incidents": "Proyectos activos señalados por la cadencia de RD + incidentes abiertos",
  "Overdue Operational Items": "Elementos operativos vencidos",
  "Corrective actions past due + stale DR cadence": "Acciones correctivas vencidas + cadencia de RD desactualizada",
  "overdue corrective actions": "acciones correctivas vencidas",
  "projects · no DR in 3+ days": "proyectos · sin RD en más de 3 días",
  "Staffing Issues": "Problemas de dotación",
  "Across": "A través de",
  "active projects (7-day DR window)": "proyectos activos (ventana de RD de 7 días)",
  "projects missing a PM": "proyectos sin PM",
  "projects missing a Foreman": "proyectos sin capataz",
  "no PM": "sin PM",
  "Equipment Issues": "Problemas de equipo",
  "Out-of-service units + open fleet defects": "Unidades fuera de servicio + defectos de flota abiertos",
  "units out of service": "unidades fuera de servicio",
  "units on monitor": "unidades en observación",
  "open fleet defects": "defectos de flota abiertos",
  "active asset holds": "bloqueos activos de activos",
  "high-severity": "alta severidad",
  "Safety Attention Items": "Elementos de atención de seguridad",
  "Unresolved incidents + open CAPAs + workplace violence + public interaction + retraining": "Incidentes sin resolver + CAPAs abiertas + violencia laboral + interacción pública + reentrenamiento",
  "unresolved incidents": "incidentes sin resolver",
  "open corrective actions": "acciones correctivas abiertas",
  "active trench-safety holds": "bloqueos activos de seguridad de zanjas",
  "workplace-violence incidents (90d)": "incidentes de violencia laboral (90 días)",
  "public-interaction incidents (30d)": "incidentes de interacción pública (30 días)",
  "incident-triggered retraining required": "reentrenamiento requerido por incidente",
  "retraining completed": "reentrenamiento completado",
  "retraining overdue": "reentrenamiento vencido",
  "Activity Snapshot (Today)": "Resumen de actividad (hoy)",
  "Is the company operating today?": "¿La empresa está operando hoy?",
  "Daily Reports submitted today": "Reportes diarios enviados hoy",
  "vs": "vs",
  "yesterday": "ayer",
  "Safety Meetings": "Reuniones de seguridad",
  "JHAs": "AST",
  ...
  "Read-only · No new collections · No background jobs · No AI · Data from existing certified records only.":
    "Solo lectura · Sin colecciones nuevas · Sin trabajos en segundo plano · Sin IA · Datos solo de registros certificados existentes.",
  ...
  "Database Capacity": "Capacidad de la Base de Datos",
  "Storage trend and capacity forecast.": "Tendencia de almacenamiento y pronóstico de capacidad.",
  "Multi-Factor Auth": "Autenticación Multifactor",
  "Super-admin MFA enrollment and recovery.": "Inscripción y recuperación MFA de superadministrador.",
  "Platform Self-Protection": "Autoprotección de la Plataforma",
  "Guardrails that keep the platform safe from itself.": "Barreras que mantienen segura a la plataforma frente a sí misma.",
  "My Profile": "Mi Perfil",
  "Account settings and preferences.": "Configuración y preferencias de la cuenta.",
  "Admin Guide": "Guía de Administración",
  "Where things live and how to run them.": "Dónde está cada cosa y cómo operarla.",
  "Operations Readiness Center": "Centro de Preparación Operativa",
  "Governance review and release readiness": "Revisión de gobernanza y preparación de liberación",
  "Admin · Governance & Trust": "Administración · Gobernanza y Confianza",
  "Operations Readiness": "Preparación Operativa",
  "Governance operations": "Operaciones de gobernanza",
  "One governed view for open experience reviews, evidence posture, blocker visibility, and release readiness.":
    "Una vista gobernada para revisiones abiertas de experiencia, postura de evidencia, visibilidad de bloqueos y preparación de liberación.",
  "{pct}% aligned": "{pct}% alineado",
  "Open current review": "Abrir revisión actual",
  "Open workflow reviews": "Revisiones abiertas de flujos",
  "Navigation reviews": "Revisiones de navegación",
  "Records & tables": "Registros y tablas",
  "Dialogs & overlays": "Diálogos y superposiciones",
  "Forms": "Formularios",
  "Screen-by-screen review status": "Estado de revisión pantalla por pantalla",
  "Current readiness board": "Tablero actual de preparación",
  "{count} ready": "{count} listas",
  "{count} blocked": "{count} bloqueadas",
  "Release readiness": "Preparación de liberación",
  "Calculated from the governed experience review inventory.":
    "Calculado a partir del inventario gobernado de revisiones de experiencia.",
  "Screens still awaiting the latest navigation and layout standard.":
    "Pantallas que aún esperan el estándar más reciente de navegación y diseño.",
  "Back / home / workflow hierarchy items still being reconciled.":
    "Los elementos de jerarquía de volver / inicio / flujo todavía se están conciliando.",
  "Structured records still being aligned to the governed reading pattern.":
    "Los registros estructurados todavía se están alineando con el patrón gobernado de lectura.",
  "Shared modal and overlay experiences still being standardized.":
    "Las experiencias compartidas de modales y superposiciones todavía se están estandarizando.",
  "Input-heavy workflows still moving to the governed field system.":
    "Los flujos con muchos campos aún se están moviendo al sistema gobernado de entradas.",
  "Helper copy still being simplified for field readability.":
    "El texto de ayuda todavía se está simplificando para la legibilidad en campo.",
  "Responsive review at 390 / 430 / 768 / 1024 / 1440 plus focused QA.":
    "Revisión responsive en 390 / 430 / 768 / 1024 / 1440 más QA enfocado.",
  "open review items and/or access blockers still remain before release signoff.":
    "aún quedan elementos abiertos de revisión y/o bloqueos de acceso antes de la aprobación de liberación.",
  "Blocking issues": "Problemas bloqueantes",
  "Review evidence log": "Registro de evidencia de revisión",
  "Protected preview workspace unavailable": "Espacio protegido de vista previa no disponible",
  "Readiness review cannot continue in Preview because the protected workspace still fails closed.":
    "La revisión de preparación no puede continuar en Preview porque el espacio protegido aún falla en modo cerrado.",
  "Admin safety and library review": "Revisión de seguridad y bibliotecas de administración",
  "Four admin workflows cleared responsive review and focused QA.":
    "Cuatro flujos de administración aprobaron la revisión responsive y el QA enfocado.",
  "Safety records and JHA review": "Revisión de registros de seguridad y AST",
  "Safety record views and the JHA workspace now share the governed reading and navigation pattern.":
    "Las vistas de registros de seguridad y el espacio AST ahora comparten el patrón gobernado de lectura y navegación.",
  "DevHub access review": "Revisión de acceso a DevHub",
  "The login surface stays stable, but authenticated DevHub access remains unavailable until the environment is corrected.":
    "La superficie de inicio de sesión permanece estable, pero el acceso autenticado a DevHub sigue sin estar disponible hasta que se corrija el entorno.",
  "Protected preview workspace": "Espacio protegido de vista previa",
  "Blocked in Preview": "Bloqueado en Preview",
  "Access environment still needs the protected DevHub credentials and endpoint enablement.":
    "El entorno de acceso aún necesita las credenciales protegidas de DevHub y la habilitación del endpoint.",
  "Admin Safety Issuance Record": "Registro de emisión de seguridad de administración",
  "Admin Safety Training Record": "Registro de capacitación de seguridad de administración",
  "Admin JHA Library": "Biblioteca AST de administración",
  "Admin Trench Box Library": "Biblioteca de cajas de zanja de administración",
  "Admin trench asset detail": "Detalle de activo de zanja de administración",
  "Safety trench asset detail": "Detalle de activo de zanja de seguridad",
  "Admin trench reports": "Reportes de zanjas de administración",
  "Shared trench shell and navigation update is active.":
    "La actualización compartida del shell y la navegación de zanjas está activa.",
  "Pending this review cycle": "Pendiente en este ciclo de revisión",
  "Needs full responsive review and final QA.": "Necesita revisión responsive completa y QA final.",
  "Shared trench shell now carries the governed navigation pattern.":
    "El shell compartido de zanjas ahora lleva el patrón gobernado de navegación.",
  "Needs final visual signoff.": "Necesita aprobación visual final.",
  ...
  "Offline — will sync": "Sin conexión — se sincronizará",
  "Syncing…": "Sincronizando…",
  "Change": "Cambiar",
  "Pick a current job — or choose Custom": "Elige un trabajo actual — o usa Personalizado",
  "MASCI Current Jobs": "Trabajos actuales de MASCI",
  "Client:": "Cliente:",
  "PM:": "PM:",
  "Field review": "Revisión de campo",
  "Why this review matters": "Por qué importa esta revisión",
  "Crews, subs, visitors, equipment, materials, weather, and photos in one governed operational review surface.": "Cuadrillas, subcontratistas, visitantes, equipo, materiales, clima y fotos en una sola superficie gobernada de revisión operativa.",
  "This list is the office routing surface for labor, weather, deliveries, visitors, photos, and job-level follow-up.": "Esta lista es la superficie de enrutamiento de oficina para mano de obra, clima, entregas, visitantes, fotos y seguimiento a nivel de proyecto.",
  "Who reviews it": "Quién lo revisa",
  "Project Management, Administration, and downstream operations teams use the same governed record to verify what happened on site.": "Gerencia de Proyectos, Administración y los equipos operativos posteriores usan el mismo registro gobernado para verificar lo que ocurrió en el sitio.",
  "Open the detail view to review the field narrative, adjust project tagging if needed, and move the report into office review.": "Abre la vista de detalle para revisar la narrativa de campo, ajustar la asignación del proyecto si hace falta y mover el reporte a revisión de oficina.",
  "If safety events, injuries, delivery failures, or document evidence look incomplete, stop the workflow and escalate before the record moves downstream.": "Si los eventos de seguridad, lesiones, fallas de entrega o la evidencia documental se ven incompletos, detén el flujo y escala antes de que el registro avance.",
  "Recent reports": "Reportes recientes",
  "Open the latest field records fast, review the crew activity, and route the next action from one consistent list.": "Abre rápido los registros de campo más recientes, revisa la actividad de la cuadrilla y enruta la siguiente acción desde una sola lista consistente.",
  "Search by project, number, preparer, date, or location": "Buscar por proyecto, número, responsable, fecha o ubicación",
  "No reports match this search": "Ningún reporte coincide con esta búsqueda",
  "Try another project name, report number, date, or preparer.": "Prueba con otro nombre de proyecto, número de reporte, fecha o responsable.",
  "Approve manual summary": "Aprobar resumen manual",
  "Manual summary accepted": "Resumen manual aprobado",
  ...
  "Transportation Academy": "Academia de Transporte",
  ...
  "Actions": "Acciones",
  "Intelligence / Cleanup": "Inteligencia / Limpieza",
  "Timeline": "Cronología",
  "Trucks / Fleet": "Camiones / Flota",
  ...
  "Mission control, live operations, carriers, drivers, fleet, compliance, and onboarding in one governed shell.":
    "Control de misión, operaciones en vivo, transportistas, conductores, flota, cumplimiento e incorporación en un solo shell gobernado.",
  "Mission Control · what needs Transportation now.": "Control de Misión · lo que Transporte necesita ahora.",
  "Dispatch · live operations · fleet visibility.": "Despacho · operaciones en vivo · visibilidad de flota.",
  "Drivers · carriers · qualifications.": "Conductores · transportistas · calificaciones.",
  "Compliance · orientation · academy.": "Cumplimiento · orientación · academia.",
  "Intelligence · automation · cleanup.": "Inteligencia · automatización · limpieza.",
  "Reports · audit trail · admin-only.": "Reportes · pista de auditoría · solo administración.",
  "Run hauling operations without shell drift, auth confusion, or dead-end navigation.":
    "Opera el acarreo sin deriva del shell, confusión de autenticación ni navegación sin salida.",
  "Transportation now uses the same canonical shell language as the rest of the platform while preserving role-based visibility for dispatch and admin users.":
    "Transporte ahora usa el mismo lenguaje canónico de shell que el resto de la plataforma, mientras preserva la visibilidad por rol para usuarios de despacho y administración.",
  "Use the sidebar for primary movement. Search is for direct access and detail discovery.":
    "Usa la barra lateral para el movimiento principal. La búsqueda es para acceso directo y descubrimiento de detalles.",
  "Search drivers, trucks, carriers, projects… (press /)":
    "Busca conductores, camiones, transportistas y proyectos… (presiona /)",
  "Search unavailable right now.": "La búsqueda no está disponible en este momento.",
  "No results for “{q}”. Try a unit number, name, project number, or DOT/MC.":
    "No hay resultados para “{q}”. Intenta con un número de unidad, nombre, número de proyecto o DOT/MC.",
  "GREEN": "VERDE",
  "YELLOW": "AMARILLO",
  "RED": "ROJO",
  "UNKNOWN": "DESCONOCIDO",
  "Transportation Operations is healthy. No action required.":
    "Operaciones de Transporte está saludable. No se requiere acción.",
  "Transportation Operations requires immediate attention.":
    "Operaciones de Transporte requiere atención inmediata.",
  "Transportation Operations operating with watch items.":
    "Operaciones de Transporte opera con elementos en observación.",
  "What Changed Today?": "¿Qué cambió hoy?",
  "What Needs Attention?": "¿Qué necesita atención?",
  "What Should We Do Next?": "¿Qué debemos hacer después?",
  "Anything Blocking?": "¿Hay algo bloqueando?",
  "Transportation Operations · Mission Control": "Operaciones de Transporte · Control de Misión",
  "One screen · five-second operational awareness. Every card answers one operational question. Composed entirely from existing engines.":
    "Una pantalla · conciencia operativa en cinco segundos. Cada tarjeta responde una sola pregunta operativa. Compuesta totalmente desde motores existentes.",
  "Fleet Ready?": "¿La flota está lista?",
  "Drivers Ready?": "¿Los conductores están listos?",
  "Carriers Ready?": "¿Los transportistas están listos?",
  "Dispatch Healthy?": "¿Despacho está saludable?",
  "{count} most-recent events across drivers, trucks, carriers, dispatch, automation, cleanup, and HR sync.":
    "{count} eventos más recientes entre conductores, camiones, transportistas, despacho, automatización, limpieza y sincronización de RR. HH.",
  "Operational workspaces": "Espacios operativos",
  "Carrier readiness": "Preparación de transportistas",
  "Driver readiness": "Preparación de conductores",
  "Truck readiness": "Preparación de camiones",
  "Onboarding queue": "Cola de incorporación",
  "Document review": "Revisión de documentos",
  "Real-time view": "Vista en tiempo real",
  "Top opportunities": "Principales oportunidades",
  "All clear — continue routine operations.": "Todo despejado — continúa las operaciones de rutina.",
  "Truck eligibility + inspection state, composed from existing fleet engines.":
    "Elegibilidad del camión + estado de inspección, compuesto desde los motores existentes de flota.",
  "Driver eligibility composed from HR lifecycle + Transportation compliance.":
    "Elegibilidad del conductor compuesta desde el ciclo de vida de RR. HH. + cumplimiento de Transporte.",
  "Carrier eligibility + packet state from the Compliance Center.":
    "Elegibilidad del transportista + estado del expediente desde el Centro de Cumplimiento.",
  "Dispatch never embedded — link only. Dispatch remains the operational system of record.":
    "Despacho nunca se incrusta — solo se enlaza. Despacho sigue siendo el sistema operativo de registro.",
  "Nothing is blocking. Transportation is clear.": "Nada está bloqueando. Transporte está despejado.",
  "Surfaced from the existing Cleanup Companion + Automation action queue. No new ranking engine.":
    "Mostrado desde el compañero de limpieza existente + cola de acciones de automatización. Sin motor de clasificación nuevo.",
  "Source · composed from Tracks 16.06 / 16.07 / 16.10 / 16.11A / 16.15 / 16.15A / 16.16":
    "Fuente · compuesto desde los Tracks 16.06 / 16.07 / 16.10 / 16.11A / 16.15 / 16.15A / 16.16",
  ...
  "Open Live Operations": "Abrir Operaciones en Vivo",
  "Open Cleanup": "Abrir Limpieza",
  "Open audit timeline": "Abrir cronología de auditoría",
  "Open the workflow": "Abrir el flujo",
  "View details →": "Ver detalles →",
  "recent events": "eventos recientes",
  "eligible trucks": "camiones elegibles",
  "eligible drivers": "conductores elegibles",
  "eligible carriers": "transportistas elegibles",
  "docs expiring 30d": "documentos que vencen en 30 días",
  "pending reviews": "revisiones pendientes",
  "docs awaiting review": "documentos en espera de revisión",
  "blocked dispatches": "despachos bloqueados",
  "readiness": "preparación",
  "open risks": "riesgos abiertos",
  "action required": "acción requerida",
  "open action items": "acciones abiertas",
  "materialized cleanup items": "elementos de limpieza materializados",
  "top priority": "prioridad principal",
  "risks queued": "riesgos en cola",
  "{count} dispatch(es) currently blocked": "{count} despacho(s) bloqueado(s) actualmente",
  "{count} HR ↔ Transportation mismatch(es)": "{count} desajuste(s) entre RR. HH. y Transporte",
  "Attention required · Top cleanup opportunity": "Atención requerida · principal oportunidad de limpieza",
  "{count} affected": "{count} afectados",
  "Recommended action:": "Acción recomendada:",
  "View in Cleanup Companion →": "Ver en el compañero de limpieza →",
  "Source: Cleanup Companion": "Fuente: compañero de limpieza",
  "Cleanup unavailable.": "La limpieza no está disponible.",
  "Loading top cleanup signal…": "Cargando la señal principal de limpieza…",
  "No cleanup signals detected. Transportation data is currently in a healthy state.":
    "No se detectaron señales de limpieza. Los datos de Transporte están actualmente en un estado saludable.",
  "Carrier packet needs correction": "El expediente del transportista necesita corrección",
  "Carrier packet is not in approved status.": "El expediente del transportista no está en estado aprobado.",
  "Approve carrier packet via Transportation admin.": "Aprueba el expediente del transportista desde la administración de Transporte.",
  "Transportation Operations navigation": "Navegación de Operaciones de Transporte",
  "This Transportation workspace ({workspace}) is restricted for your role.":
    "Este espacio de Transporte ({workspace}) está restringido para tu rol.",
  "This Transportation data is not available for your role.":
    "Estos datos de Transporte no están disponibles para tu rol.",
  "Contact your dispatcher lead or operations manager to request access.":
    "Contacta a tu líder de despacho o gerente de operaciones para solicitar acceso.",
  ...
  "Could not load photos. Try again.": "No se pudieron cargar las fotos. Inténtalo de nuevo.",
  "Search jobs / submitter…": "Buscar trabajos / autor…",
  "All sources": "Todas las fuentes",
  "Daily Report": "Reporte Diario",
  "Site Inspection": "Inspección de Sitio",
  "Daily Reports": "Reportes Diarios",
  "Site Inspections": "Inspecciones de Sitio",
  "QA/QC": "QA/QC",
  "Daily Reports · Site Inspections · QA/QC · multi-select, download ZIP, email packet.":
    "Reportes Diarios · Inspecciones de Sitio · QA/QC · selección múltiple, descargar ZIP y enviar paquete por correo.",
  ...
  "Photo data unavailable or corrupt.": "Los datos de la foto no están disponibles o están corruptos.",
  "Send": "Enviar",
  ...
  // 2026-06 · preview acceptance sweep — public hero + CTAs + sync-status + HR surfaces
  "Start field work fast with field reporting, safety, quality, equipment, workforce accountability, transportation, and project operations in one trusted system built for heavy-civil operations.": "Empiece el trabajo de campo rápido con reportes de campo, seguridad, calidad, equipos, responsabilidad del personal, transporte y operaciones de proyecto en un solo sistema confiable, diseñado para operaciones de obra pesada.",
  "Start field reporting": "Iniciar reporte de campo",
  "Open guidance": "Abrir guía",
  "Open cheat sheet": "Abrir guía rápida",
  "All Reports Synced": "Todos los reportes sincronizados",
  "Pending Uploads": "Cargas pendientes",
  "Attention Required": "Atención requerida",
  "Compliance At Risk": "Cumplimiento en riesgo",
  "Loading live compliance signals…": "Cargando señales de cumplimiento en vivo…",
  "Unable to load live compliance signals.": "No se pudieron cargar las señales de cumplimiento en vivo.",
  "Employees or documents that likely need HR review before risk becomes an incident.": "Empleados o documentos que probablemente necesitan revisión de RR. HH. antes de que el riesgo se convierta en incidente.",
  "No compliance risk right now.": "Sin riesgo de cumplimiento en este momento.",
  "No expired documents and none expiring in the next 30 days.": "Sin documentos vencidos ni por vencer en los próximos 30 días.",
  "Expired": "Vencido",
  ...
  "overdue": "atrasado",
  "Today’s focus": "Enfoque de hoy",
  "Keep the workforce ready by showing attention, next actions, and the shortest path to real records.": "Mantenga al personal listo mostrando la atención, las próximas acciones y el camino más corto hacia registros reales.",
  "See requests, renewals, and record issues in one place so HR can act fast.": "Vea solicitudes, renovaciones y problemas de registros en un solo lugar para que RR. HH. actúe rápido.",
  "Employees": "Empleados",
  "Accountability": "Responsabilidad",
  "Workforce attention right now": "Atención del personal ahora mismo",
  "Open in Cockpit": "Abrir en el panel",
  "No attention items — portal is calm.": "Sin elementos de atención: el portal está en calma.",
  "Insufficient data · consult Cockpit.": "Datos insuficientes · consulte el panel.",
  "Retry": "Reintentar",
  " (timed out)": " (tiempo agotado)",
  " (network error)": " (error de red)",
  "Admin token required to view OI signals · request access from your administrator.": "Se requiere token de administrador para ver las señales de OI · solicite acceso a su administrador.",
  "Administrative intelligence is unavailable. Configuration, trust, and system controls remain available.": "La inteligencia administrativa no está disponible. La configuración, la confianza y los controles del sistema siguen disponibles.",
  "Project intelligence is unavailable. Project records, daily reports, photos, and reviews remain available.": "La inteligencia de proyectos no está disponible. Los registros de proyecto, los reportes diarios, las fotos y las revisiones siguen disponibles.",
  "Safety intelligence is unavailable. Incidents, meetings, JHPs, training, and trench safety remain available.": "La inteligencia de seguridad no está disponible. Los incidentes, las reuniones, los JHP, la capacitación y la seguridad en zanjas siguen disponibles.",
  "HR intelligence is unavailable. Employee lifecycle, requests, documents, and qualifications remain available.": "La inteligencia de RR. HH. no está disponible. El ciclo de vida del empleado, las solicitudes, los documentos y las cualificaciones siguen disponibles.",
  "Shop intelligence is unavailable. Equipment attention, repairs, holds, and recovery workflows remain available.": "La inteligencia del taller no está disponible. La atención a equipos, las reparaciones, las retenciones y los flujos de recuperación siguen disponibles.",
  "Operational intelligence is temporarily unavailable. Core portal workflows remain available.": "La inteligencia operativa no está disponible temporalmente. Los flujos de trabajo principales del portal siguen disponibles.",
  ...
  // WP-17D recertification sweep · admin, PM, Shop, and root families
  "Material Calculator Usage": "Uso de la Calculadora de Materiales",
  "Calculator runs": "Ejecuciones de la calculadora",
  "Every time a field user hits": "Cada vez que un usuario de campo pulsa",
  "on Field → Material Calculators, the inputs and results land here.": "en Campo → Calculadoras de Materiales, las entradas y los resultados aparecen aquí.",
  ...
  "Safety Department": "Departamento de Seguridad",
  "Safety Forms": "Formularios de Seguridad",
  "Equipment Issuance & Accountability and Use & Care Training records.": "Registros de entrega y responsabilidad de equipo y de capacitación de uso y cuidado.",
  "Auto-emailed to": "Enviado automáticamente por correo a",
  "your safety inbox": "su bandeja de seguridad",
  "on submit.": "al enviar.",
  "Issuance": "Entrega",
  "record": "registro",
  "records": "registros",
  "Jobs Assigned to You": "Trabajos asignados a usted",
  "active job": "trabajo activo",
  "active jobs": "trabajos activos",
  "Admin view — every job visible": "Vista de administrador — todos los trabajos visibles",
  "Scoped to jobs where you are primary or co-PM.": "Limitado a trabajos donde usted es PM principal o co-PM.",
  "Search project #, name, location…": "Buscar proyecto #, nombre, ubicación…",
  "No jobs are currently assigned to you. Ask your administrator if a job should be linked to your account.": "Actualmente no hay trabajos asignados a usted. Pida a su administrador que vincule un trabajo con su cuenta si corresponde.",
  "Primary PM": "PM principal",
  "Co-PMs": "Co-PMs",
  "Setup": "Configuración",
  "% Complete": "% completado",
  ...
  "PM Portal": "Portal PM",
  "PM · QA/QC": "PM · QA/QC",
  "Records are filtered to jobs where you are the assigned PM.": "Los registros se filtran a trabajos donde usted es el PM asignado.",
  "Viewing as": "Viendo como",
  "— Pick your name —": "— Elija su nombre —",
  "Equipment Pre-Op": "Preoperacional de equipo",
  "Share Equipment Form": "Compartir formulario de equipo",
  "Anyone with this link can file an Equipment Pre-Op Inspection. No login required.": "Cualquier persona con este enlace puede presentar una inspección preoperacional de equipo. No requiere inicio de sesión.",
  "New Inspection": "Nueva inspección",
  "Field readiness": "Preparación de campo",
  "Daily Walk-Arounds": "Recorridos diarios",
  "OSHA pre-shift inspections for every truck, excavator, roller, and tool on the job. Review the latest condition, open issues, and cleared units from one governed surface.": "Inspecciones preturno de OSHA para cada camión, excavadora, rodillo y herramienta en la obra. Revise la condición más reciente, los problemas abiertos y las unidades liberadas desde una sola superficie gobernada.",
  "unit flagged fail": "unidad marcada como fallida",
  "units flagged fail": "unidades marcadas como fallidas",
  "Pre-Op trends and inspections": "Tendencias e inspecciones preoperacionales",
  "Monitor current condition, open issues, and the latest inspection records without switching visual systems.": "Monitoree la condición actual, los problemas abiertos y los registros de inspección más recientes sin cambiar de sistema visual.",
  "Pre-Op Trends & Recent Inspections": "Tendencias preoperacionales e inspecciones recientes",
  "Download Full Backup": "Descargar copia de seguridad completa",
  "Back to Shop": "Volver al Taller",
  "Dashboard": "Panel",
  "Profile": "Perfil",
  "PM Engine summary is not available for your role. Use the PM Dashboard link below to view detail.": "El resumen del motor PM no está disponible para su rol. Use el enlace del panel PM de abajo para ver el detalle.",
  "Project Management": "Gestión de Proyectos",
  "Today’s PM decisions, blockers, and the next queue to open — with less noise and no dead-end navigation.": "Las decisiones PM de hoy, los bloqueos y la siguiente cola por abrir — con menos ruido y sin navegación sin salida.",
  "Refreshed {time}": "Actualizado {time}",
  "Loading live signals…": "Cargando señales en vivo…",
  "Portal mission": "Misión del portal",
  "Build the project by clearing the next real blocker.": "Impulse el proyecto resolviendo el siguiente bloqueo real.",
  "Purchase Requests": "Solicitudes de compra",
  "PO requests awaiting your approval · receipts due from the field · overdue receipts that need a chase.": "Solicitudes de orden de compra esperando su aprobación · recibos pendientes desde campo · recibos vencidos que requieren seguimiento.",
  "01 · Action queues · live": "01 · Colas de acción · en vivo",
  "Open PM work": "Abrir trabajo PM",
  "Counts are queue sizes pulled live. Clicking a card opens the real PM workflow.": "Los conteos son tamaños de cola tomados en vivo. Al hacer clic en una tarjeta se abre el flujo de trabajo PM real.",
  "Unified Holds": "Bloqueos unificados",
  "Equipment + Operational Constraints + Fleet Defects aggregated across your projects": "Equipo + restricciones operativas + defectos de flota agregados en sus proyectos",
  "Live count · equipment, constraints, defects": "Conteo en vivo · equipo, restricciones, defectos",
  "Due Today": "Vence hoy",
  "CAPAs dated today + Daily Reports for today awaiting your verify": "CAPAs con fecha de hoy + reportes diarios de hoy esperando su verificación",
  "Live count · real deadlines for today": "Conteo en vivo · vencimientos reales de hoy",
  "Recent field activity": "Actividad reciente de campo",
  "What requires your attention today?": "¿Qué requiere su atención hoy?",
  "HR purpose: keep the workforce ready. Every queue below is a live count — open it to see who needs your attention today.": "Propósito de RR. HH.: mantener a la fuerza laboral lista. Cada cola abajo es un conteo en vivo — ábrala para ver quién necesita su atención hoy.",
  "HR Intelligence · attention now": "Inteligencia de RR. HH. · atención ahora",
  "Counts are queue sizes pulled live. Clicking a card opens the real HR workflow — no mock data, no synthesized values.": "Los conteos son tamaños de cola tomados en vivo. Al hacer clic en una tarjeta se abre el flujo de trabajo real de RR. HH. — sin datos simulados ni valores sintetizados.",
  "Employee Directory": "Directorio de empleados",
  "Find a person": "Encontrar a una persona",
  "Search by name, preferred name, or job title…": "Buscar por nombre, nombre preferido o cargo…",
  "Search employee directory": "Buscar en el directorio de empleados",
  "Open full directory →": "Abrir directorio completo →",
  "Live search across the active HR roster. No keyboard shortcut needed.": "Búsqueda en vivo en la plantilla activa de RR. HH. No se necesita atajo de teclado.",
  "Why this number?": "¿Por qué este número?",
  "Open workflow →": "Abrir flujo de trabajo →",
  "What safety work requires attention right now?": "¿Qué trabajo de seguridad requiere atención en este momento?",
  "Every queue is a live count — open it to see what Safety needs to act on today. Trench Safety workflows live under Trench Safety.": "Cada cola es un conteo en vivo — ábrala para ver en qué debe actuar Seguridad hoy. Los flujos de trabajo de seguridad de zanjas viven bajo Seguridad de Zanjas.",
  "Safety Intelligence · attention now": "Inteligencia de Seguridad · atención ahora",
  "Counts pulled live. Click a card to open the real Safety CAPA workflow.": "Conteos tomados en vivo. Haga clic en una tarjeta para abrir el flujo de trabajo CAPA real de Seguridad.",
  "Shop Operations": "Operaciones de Taller",
  "Shop Command Center": "Centro de mando del taller",
  "What needs attention · what's assigned · what's waiting. Repair complete still requires RTS verification by Dispatch.": "Qué necesita atención · qué está asignado · qué está esperando. La reparación completa aún requiere verificación RTS por Despacho.",
  "Equipment Pre-Ops": "Preoperacionales de equipo",
  "Fleet Visibility": "Visibilidad de flota",
  "New Fuel/Lube Visit": "Nueva visita de combustible/lubricación",
  ...
  "Action": "Acción",
  "Clear": "Despejado",
  "Asset Care": "Cuidado del activo",
  "Readiness · documents · renewals · alerts across the asset spine.": "Preparación · documentos · renovaciones · alertas a lo largo del sistema de activos.",
  "Shop Portal · Manager Queue": "Portal de Taller · Cola del gerente",
  "Shop Manager Queue": "Cola del gerente del taller",
  "Every defect by assignment state. Assign · reassign · review repairs. Repair complete still requires return-to-service verification by Dispatch.": "Cada defecto por estado de asignación. Asigne · reasigne · revise reparaciones. La reparación completa aún requiere verificación de retorno al servicio por Despacho.",
  "Shop Portal · My Assignments": "Portal de Taller · Mis asignaciones",
  "My Assignments": "Mis asignaciones",
  "Defects assigned to you. Accept, start, then complete with repair notes and parts used. Repair complete still requires return-to-service verification by Dispatch.": "Defectos asignados a usted. Acepte, inicie y luego complete con notas de reparación y piezas usadas. La reparación completa aún requiere verificación de retorno al servicio por Despacho.",
  "Shop Portal · Unit History": "Portal de Taller · Historial de unidad",
  "Open a unit's timeline": "Abrir la línea de tiempo de una unidad",
  "Type a unit number to see its complete operational history — pre-ops, defects, repairs, parts, fuel/lube, return-to-service.": "Escriba un número de unidad para ver su historial operativo completo — preoperacionales, defectos, reparaciones, piezas, combustible/lubricación y retorno al servicio.",
  "Shop Portal · Fuel / Lube Visit": "Portal de Taller · Visita de combustible / lubricación",
  "Fuel / Lube Visit Record": "Registro de visita de combustible / lubricación",
  "One job visit · multiple equipment lines. Each service entry is saved to the unit's history. Issues create shop defects automatically.": "Una visita de obra · múltiples líneas de equipo. Cada servicio se guarda en el historial de la unidad. Los problemas crean defectos de taller automáticamente.",
  "Shop Portal · Fuel/Lube Records": "Portal de Taller · Registros de combustible/lubricación",
  "Fuel / Lube Visit Records": "Registros de visitas de combustible / lubricación",
  "Submitted job-based service visits with fuel, fluids, grease, meter readings, and field-discovered issues.": "Visitas de servicio enviadas por obra con combustible, fluidos, grasa, lecturas de medidor y problemas detectados en campo.",
  ...
  "Field Leadership · ODR Center": "Liderazgo de Campo · Centro ODR",
  "scope loading": "cargando alcance",
  "verb": "verbo",
  "Needs Attention": "Necesita atención",
  "Drafts and returned records waiting on you.": "Borradores y registros devueltos esperándolo.",
  "Recently Submitted": "Enviados recientemente",
  "What the field reported recently.": "Lo que el campo reportó recientemente.",
  "Recently Amended": "Enmendados recientemente",
  "Records changed after submission.": "Registros cambiados después del envío.",
  "Ready for Review": "Listos para revisión",
  "Submitted records awaiting your approval.": "Registros enviados esperando su aprobación.",
  "Constraint-Linked": "Vinculados a restricciones",
  "ODRs tied to active constraints.": "ODR vinculados a restricciones activas.",
  "Chronology": "Cronología",
  "Recent events across your scope.": "Eventos recientes dentro de su alcance.",
  "Readiness Signals": "Señales de preparación",
  "Records with open hard stops or missing required items.": "Registros con bloqueos abiertos o elementos requeridos faltantes.",
  "Nothing here right now. That's good.": "No hay nada aquí ahora mismo. Eso es bueno.",
  "amend": "enmienda",
  "MASCI Operational Records": "Registros Operativos MASCI",
  "Operational Records": "Registros Operativos",
  "Every project record across MASCI Ops in one place. New entries are filed as Operational Daily Records (ODR). Historical Daily Reports remain available, byte-identical to the day they were signed.": "Todos los registros del proyecto en MASCI Ops en un solo lugar. Las nuevas entradas se archivan como Registros Operativos Diarios (ODR). Los Reportes Diarios históricos siguen disponibles, idénticos byte por byte al día en que se firmaron.",
  "Search doc id, project, foreman…": "Buscar ID del documento, proyecto, capataz…",
  "Project number": "Número de proyecto",
  "record(s)": "registro(s)",
  "archived": "archivados",
  "Loading records…": "Cargando registros…",
  "No records matched.": "No hubo registros coincidentes.",
  "Foreman": "Capataz",
  "Super": "Super",
  "Photos": "Fotos",
  "Foreman signed": "Capataz firmó",
  "Super signed": "Super firmó",
  "Original format preserved": "Formato original preservado",
  "crit": "crít",
  "med": "med",
  "(unnamed)": "(sin nombre)",
  "Sign-in required": "Se requiere iniciar sesión",
  "Project Performance": "Desempeño del Proyecto",
  "Current project view": "Vista actual del proyecto",
  "Export CSV": "Exportar CSV",
  "Loading project performance…": "Cargando desempeño del proyecto…",
  "Choose a project to view project performance.": "Elija un proyecto para ver el desempeño del proyecto.",
  "Verified field updates": "Actualizaciones de campo verificadas",
  "Items needing review": "Elementos que necesitan revisión",
  "Recommended actions": "Acciones recomendadas",
  "Unassigned records": "Registros sin asignar",
  "Every KPI below is built from Work Blocks, approved progress updates, budget lines, and schedule activities.": "Cada KPI de abajo se construye a partir de Bloques de Trabajo, actualizaciones de avance aprobadas, líneas de presupuesto y actividades del cronograma.",
  "Installed quantity by unit": "Cantidad instalada por unidad",
  "Accepted": "Aceptado",
  "Rejected": "Rechazado",
  "Budget lines": "Líneas de presupuesto",
  "Schedule activities": "Actividades del cronograma",
  "Reports": "Reportes",
  "Production pace": "Ritmo de producción",
  "Daily": "Diario",
  "Weekly": "Semanal",
  "14-day": "14 días",
  "Pace": "Ritmo",
  "Resource performance": "Desempeño de recursos",
  "Recommended next actions": "Próximas acciones recomendadas",
  "Record different decision": "Registrar decisión diferente",
  "Owner": "Responsable",
  "Not assigned yet": "Aún sin asignar",
  "Drill-down": "Detalle",
  "Evidence": "Evidencia",
  "Source": "Fuente",
  "Different field decision": "Decisión de campo diferente",
  "No recommended actions are open right now.": "No hay acciones recomendadas abiertas en este momento.",
  "How this page is built": "Cómo se construye esta página",
  "You are seeing": "Usted está viendo",
  "Built from": "Construido a partir de",
  "Daily Reports, Work Blocks, approved progress updates, budget lines, and schedule activities": "Reportes Diarios, Bloques de Trabajo, actualizaciones de avance aprobadas, líneas de presupuesto y actividades del cronograma",
  "Connected views": "Vistas conectadas",
  "This keeps the original recommendation, saves your decision, and preserves the evidence trail.": "Esto conserva la recomendación original, guarda su decisión y preserva el rastro de evidencia.",
  "Explain why you are taking a different action.": "Explique por qué está tomando una acción diferente.",
  "Save decision": "Guardar decisión",
  "How it's calculated": "Cómo se calcula",
  "Updated": "Actualizado",
  "Source records": "Registros fuente",
  "Watchouts": "Puntos de atención",
  "No records are available yet for this view.": "Todavía no hay registros disponibles para esta vista.",
  "No linked Work Blocks": "Sin Bloques de Trabajo vinculados",
  ...
  "Pending PM review": "Pendiente de revisión PM",
  "Proposed only": "Solo propuesto",
  "Not started": "No iniciado",
  "Running": "En ejecución",
  "Needs attention": "Necesita atención",
  "Current approved budget": "Presupuesto aprobado actual",
  "Original approved budget": "Presupuesto aprobado original",
  "Master schedule": "Cronograma maestro",
  "Baseline refresh": "Actualización de línea base",
  "Pending revision": "Pendiente de revisión",
  "Approved": "Aprobado",
  "Deferred": "Diferido",
  "Active": "Activo",
  "Archived": "Archivado",
  ...
  "Completed": "Completado",
  "Resolved": "Resuelto",
  "Schedule progress CSV": "CSV de avance del cronograma",
  "Project performance is unavailable right now.": "El desempeño del proyecto no está disponible en este momento.",
  "Project performance export downloaded.": "La exportación de desempeño del proyecto se descargó.",
  "Could not export project performance.": "No se pudo exportar el desempeño del proyecto.",
  "Could not save the field decision.": "No se pudo guardar la decisión de campo.",
  "See what changed, why it matters, what needs action next, and what evidence supports it for this job.": "Vea qué cambió, por qué importa, qué necesita acción ahora y qué evidencia lo respalda para esta obra.",
  "Operations Dashboard Review": "Revisión del Tablero de Operaciones",
  "Operations dashboard review is unavailable right now.": "La revisión del tablero de operaciones no está disponible en este momento.",
  "Update existing records queued.": "La actualización de registros existentes quedó en cola.",
  "Could not queue update existing records.": "No se pudo poner en cola la actualización de registros existentes.",
  "Admin review for project performance, evidence links, items needing review, and update status.": "Revisión administrativa del desempeño del proyecto, vínculos de evidencia, elementos que necesitan revisión y estado de actualización.",
  "Project performance": "Desempeño del proyecto",
  "Use this page to refresh current project views, monitor unassigned records, and confirm that PM-facing metrics still come from one approved source path.": "Use esta página para actualizar las vistas actuales del proyecto, monitorear registros sin asignar y confirmar que las métricas visibles para PM siguen viniendo de una sola ruta aprobada.",
  "Update existing records status": "Estado de actualización de registros existentes",
  "Projects processed": "Proyectos procesados",
  "Current views built": "Vistas actuales construidas",
  "Operations Dashboard": "Tablero de Operaciones",
  "Admin review over the same project-performance view used by PMs. Issues stay visible, explainable, and non-destructive.": "Revisión administrativa sobre la misma vista de desempeño del proyecto usada por los PM. Los problemas siguen visibles, explicables y no destructivos.",
  "Latest current project views": "Últimas vistas actuales del proyecto",
  "Project": "Proyecto",
  "Verified updates": "Actualizaciones verificadas",
  "Projects with current views": "Proyectos con vistas actuales",
  "Could not load project controls.": "No se pudieron cargar los controles del proyecto.",
  "Work type link saved.": "Se guardó el vínculo del tipo de trabajo.",
  "Project Controls": "Controles del Proyecto",
  "Set pay items, work type links, lookahead notes, job status, and crew decisions for this job.": "Defina partidas, vínculos de tipos de trabajo, notas de planificación, estado de la obra y decisiones de cuadrillas para esta obra.",
  "Pay items stay job-specific, company work types stay admin-managed, and approved links connect the two without changing Daily Reports.": "Las partidas siguen siendo específicas de la obra, los tipos de trabajo de la empresa siguen gestionados por administración y los vínculos aprobados conectan ambos sin cambiar los Reportes Diarios.",
  "Approved links": "Vínculos aprobados",
  "Crew suggestions": "Sugerencias de cuadrilla",
  "Work blocks": "Bloques de Trabajo",
  "Approved work type links": "Vínculos aprobados de tipos de trabajo",
  "Link each pay item to the right company work type. Nothing is approved automatically.": "Vincule cada partida con el tipo de trabajo correcto de la empresa. Nada se aprueba automáticamente.",
  "Save link": "Guardar vínculo",
  "Field progress can inform this view, but the PM-published plan remains the schedule source.": "El avance de campo puede informar esta vista, pero el plan publicado por PM sigue siendo la fuente del cronograma.",
  "Job status & archive": "Estado y archivo de la obra",
  "Archiving keeps history. Every record stays searchable under the same permissions.": "Archivar conserva el historial. Cada registro sigue siendo buscable bajo los mismos permisos.",
  "Restore job": "Restaurar obra",
  "Archive job": "Archivar obra",
  "Crew patterns stay suggestions until a person confirms them.": "Los patrones de cuadrilla siguen siendo sugerencias hasta que una persona los confirme.",
  "Recent work blocks": "Bloques de trabajo recientes",
  "No linked cost code yet": "Todavía no hay código de costo vinculado",
  "No work blocks yet. Daily Reports will add them automatically when field work is entered.": "Todavía no hay bloques de trabajo. Los Reportes Diarios los agregarán automáticamente cuando se ingrese trabajo de campo.",
  ...
  "Update existing records finished.": "La actualización de registros existentes terminó.",
  "Could not update existing records.": "No se pudieron actualizar los registros existentes.",
  "Company work types": "Tipos de trabajo de la empresa",
  "Data rules": "Reglas de datos",
  "These stay admin-managed and are reused across projects.": "Estos siguen gestionados por administración y se reutilizan entre proyectos.",
  "Could not load project controls standards.": "No se pudieron cargar los estándares de controles del proyecto.",
  "Project Budget": "Presupuesto del Proyecto",
  "Could not load the project budget.": "No se pudo cargar el presupuesto del proyecto.",
  "Budget version activated.": "La versión del presupuesto fue activada.",
  "Review budget imports, approve line setup, and activate the budget version without guessing job cost truth.": "Revise importaciones de presupuesto, apruebe la configuración de líneas y active la versión del presupuesto sin adivinar la verdad del costo de obra.",
  "Budget setup": "Configuración del presupuesto",
  "Customer pay items stay contract truth, company work types stay admin-managed, and each budget line stays ready for job cost review.": "Las partidas del cliente siguen siendo la verdad contractual, los tipos de trabajo de la empresa siguen gestionados por administración y cada línea del presupuesto queda lista para revisión de costo de obra.",
  "Budget versions": "Versiones de presupuesto",
  "Active lines": "Líneas activas",
  "Financial rules": "Reglas financieras",
  "Imports never activate automatically. PM approval is required, unclear rows stay in review, and commitments plus actual costs stay separate from the budget itself.": "Las importaciones nunca se activan automáticamente. Se requiere aprobación del PM, las filas poco claras quedan en revisión y los compromisos más los costos reales permanecen separados del presupuesto.",
  "Import for review": "Importar para revisión",
  "Supported entry lanes include SOV, bid tabs, pay-item lists, CSV, Excel, and PDF review. Nothing activates until you approve it.": "Las vías de entrada compatibles incluyen SOV, tablas de oferta, listas de partidas, CSV, Excel y revisión PDF. Nada se activa hasta que usted lo apruebe.",
  "Start import review": "Iniciar revisión de importación",
  "Review imported rows": "Revisar filas importadas",
  "Workflow: import → suggested matches → PM review → PM approval → activation.": "Flujo: importación → coincidencias sugeridas → revisión PM → aprobación PM → activación.",
  "Activate budget version": "Activar versión del presupuesto",
  "Unnumbered pay item": "Partida sin número",
  "Original source": "Fuente original",
  "Suggested match": "Coincidencia sugerida",
  "Active budget": "Presupuesto activo",
  "Budget, commitments, receipts, forecast, revenue, billing, and collections stay separate here.": "Presupuesto, compromisos, recibos, proyección, ingresos, facturación y cobros permanecen separados aquí.",
  "Each line stays ready for work blocks, crews, equipment, materials, vendors, subcontractors, commitments, receipts, and forecasts.": "Cada línea queda lista para bloques de trabajo, cuadrillas, equipo, materiales, proveedores, subcontratistas, compromisos, recibos y proyecciones.",
  "Unknown financial links stay here with a reason. Nothing is guessed or silently changed.": "Los vínculos financieros desconocidos quedan aquí con una razón. Nada se adivina ni se cambia en silencio.",
  "No budget items need review right now.": "No hay partidas de presupuesto que necesiten revisión en este momento.",
  "PO links needing review": "Vínculos de OC que necesitan revisión",
  "No PO links need review for this project yet.": "Todavía no hay vínculos de OC que necesiten revisión para este proyecto.",
  "Receipts needing review": "Recibos que necesitan revisión",
  "No receipts need review for this project yet.": "Todavía no hay recibos que necesiten revisión para este proyecto.",
  "Project Budget Review": "Revisión del Presupuesto del Proyecto",
  "Review budget imports, open financial questions, and active versions without changing accounting truth.": "Revise importaciones de presupuesto, preguntas financieras abiertas y versiones activas sin cambiar la verdad contable.",
  "Budget update existing records completed.": "La actualización de registros existentes del presupuesto se completó.",
  "Could not update existing budget records.": "No se pudieron actualizar los registros existentes del presupuesto.",
  "Recent import reviews": "Revisiones de importación recientes",
  "Project Schedule": "Cronograma del Proyecto",
  "Project Schedule Review": "Revisión del Cronograma del Proyecto",
  "Could not load the project schedule.": "No se pudo cargar el cronograma del proyecto.",
  "Email export queued for review.": "La exportación por correo quedó en cola para revisión.",
  "Review schedule imports, work packages, assignments, and lookahead plans without changing the baseline.": "Revise importaciones del cronograma, paquetes de trabajo, asignaciones y planes de anticipación sin cambiar la línea base.",
  "Operational planning": "Planificación operativa",
  "The schedule stays connected to work packages, budget lines, pay items, work blocks, Daily Reports, and actual production. Imports stay in review until a PM approves activation.": "El cronograma permanece conectado con paquetes de trabajo, líneas de presupuesto, partidas, bloques de trabajo, Reportes Diarios y producción real. Las importaciones quedan en revisión hasta que un PM apruebe la activación.",
  "Versions": "Versiones",
  "Activities": "Actividades",
  "Proposed updates": "Actualizaciones propuestas",
  "Approved updates": "Actualizaciones aprobadas",
  "Planning rules": "Reglas de planificación",
  "CSV is the certified import lane today. P6, Microsoft Project, Excel, and PDF imports stay extension paths until runtime testing is complete. Daily Reports stay the field-execution source.": "CSV es hoy la vía de importación certificada. P6, Microsoft Project, Excel y PDF siguen siendo rutas de extensión hasta completar la prueba en ejecución. Los Reportes Diarios siguen siendo la fuente de ejecución de campo.",
  "Workflow: import → suggested matches → PM review → PM edits → PM approval → activation. Nothing activates automatically.": "Flujo: importación → coincidencias sugeridas → revisión PM → ediciones PM → aprobación PM → activación. Nada se activa automáticamente.",
  "Review imported activities": "Revisar actividades importadas",
  "Review unresolved links before this becomes the active planning schedule.": "Revise los vínculos sin resolver antes de que esto se convierta en el cronograma activo de planificación.",
  "Active schedule": "Cronograma activo",
  "No forecast rows yet. Approve progress updates to begin the forecast view.": "Todavía no hay filas de proyección. Apruebe actualizaciones de avance para iniciar la vista de proyección.",
  "Exports": "Exportaciones",
  "No work packages yet.": "Todavía no hay paquetes de trabajo.",
  "This is the operating view of the master schedule. PM edits here do not change the baseline schedule version.": "Esta es la vista operativa del cronograma maestro. Las ediciones del PM aquí no cambian la versión base del cronograma.",
  "One constraint per line": "Una restricción por línea",
  "Unclear schedule links stay here with a reason instead of becoming silent schedule truth.": "Los vínculos poco claros del cronograma permanecen aquí con una razón en lugar de convertirse en verdad silenciosa del cronograma.",
  "No schedule items need review right now.": "No hay elementos del cronograma que necesiten revisión en este momento.",
  "CSV is the certified import lane today. P6, Microsoft Project, Excel, and PDF imports stay review paths until field validation is complete. Daily Reports stay the field-execution source.": "CSV es hoy la vía de importación certificada. P6, Microsoft Project, Excel y PDF siguen siendo rutas de revisión hasta completar la validación en campo. Los Reportes Diarios siguen siendo la fuente de ejecución de campo.",
  "Progress updates": "Actualizaciones de avance",
  "Schedule update existing records queued.": "La actualización de registros existentes del cronograma quedó en cola.",
  "Could not update existing schedule records.": "No se pudieron actualizar los registros existentes del cronograma.",
  "No progress-update evidence found yet.": "Todavía no hay evidencia de actualizaciones de avance.",
  "The schedule remains planning truth only. Budget, commitments, actual cost, forecast, revenue, billing, and collections stay separate. Constraints remain operational records, not free-form notes.": "El cronograma sigue siendo solo la verdad de planificación. Presupuesto, compromisos, costo real, proyección, ingresos, facturación y cobros permanecen separados. Las restricciones siguen siendo registros operativos, no notas libres.",
  "Progress update oversight": "Supervisión de actualizaciones de avance",
  "Admin can inspect proposed updates, approved progress, and daily work-plan publication without becoming the project decision gate.": "Administración puede revisar actualizaciones propuestas, avances aprobados y publicación del plan diario sin convertirse en la puerta de decisión del proyecto.",
  "Recent progress-update evidence": "Evidencia reciente de actualizaciones de avance",
  "Executive Operations Dashboard": "Tablero Ejecutivo de Operaciones",
  "Executive operations dashboard": "Tablero ejecutivo de operaciones",
  "Portfolio-wide operating picture for leadership decisions, briefing readiness, and resource risk.": "Panorama operativo de toda la cartera para decisiones de liderazgo, preparación del informe y riesgo de recursos.",
  "Current portfolio view in plain English": "Vista actual de la cartera en lenguaje claro",
  "Use this page to understand what landed in the selected period, which projects need leadership attention, and whether the enterprise briefing is ready for distribution.": "Use esta página para entender qué ocurrió en el periodo seleccionado, qué proyectos necesitan atención de liderazgo y si el informe empresarial está listo para distribuirse.",
  "Projects reporting": "Proyectos reportando",
  "Briefing status": "Estado del informe",
  "Loading portfolio evidence…": "Cargando evidencia de la cartera…",
  "What happened": "Qué pasó",
  "Portfolio totals in range": "Totales de la cartera en el rango",
  "What is happening": "Qué está pasando",
  "Top-at-risk projects by delay and safety": "Proyectos con mayor riesgo por demora y seguridad",
  "What needs attention": "Qué necesita atención",
  "Variance, recovery, and resource coordination from the enterprise operations center": "Variaciones, recuperación y coordinación de recursos desde el centro de operaciones empresarial",
  "Portfolio briefing lifecycle, freeze state, and executive narrative": "Ciclo de vida del informe de cartera, estado de congelación y narrativa ejecutiva",
  "Project name not reported": "Nombre del proyecto no reportado",
  "Project reference not reported": "Referencia del proyecto no reportada",
  "Delay hrs": "Horas de demora",
  "Blockers": "Bloqueos",
  "Labor hrs": "Horas de mano de obra",
  "Load failed": "La carga falló",
  "Briefing action failed": "La acción del informe falló",
  "No at-risk projects in this range.": "No hay proyectos en riesgo en este rango.",
  "Safety findings": "Hallazgos de seguridad",
  "Quality findings": "Hallazgos de calidad",
  "Active delays": "Demoras activas",
  "Readiness blockers": "Bloqueos de preparación",
  "Projects needing leadership review": "Proyectos que necesitan revisión de liderazgo",
  "Recovery overdue": "Recuperación vencida",
  "No portfolio projects are currently escalated for leadership review.": "Actualmente no hay proyectos de la cartera escalados para revisión de liderazgo.",
  "No active resource conflicts are reported right now.": "No se reportan conflictos activos de recursos en este momento.",
  "Recovery plans that slipped": "Planes de recuperación atrasados",
  "strategy pending": "estrategia pendiente",
  "No overdue recovery plans are reported right now.": "No se reportan planes de recuperación vencidos en este momento.",
  "Week ending": "Semana que termina",
  "Not selected yet": "Aún no seleccionado",
  "Approvals and freezes recorded": "Aprobaciones y congelamientos registrados",
  "No executive narrative is published yet. Generate the latest briefing to build the summary from current operating evidence.": "Aún no se publica una narrativa ejecutiva. Genere el informe más reciente para construir el resumen con la evidencia operativa actual.",
  "Warnings": "Advertencias",
  "No warning text was returned": "No se devolvió texto de advertencia",
  "Generate latest": "Generar lo más reciente",
  "Freeze": "Congelar",
  "Not generated yet": "Aún no generado",
  "Executive views now use the same shared work area while staying concise, role-appropriate, and operationally clear.": "Las vistas ejecutivas ahora usan la misma área de trabajo compartida mientras siguen siendo concisas, adecuadas al rol y operativamente claras.",
  "Progress update review": "Revisión de actualización de avance",
  "Daily Reports stay the field source. PM review decides what updates the current schedule and forecast.": "Los Reportes Diarios siguen siendo la fuente de campo. La revisión del PM decide qué actualiza el cronograma actual y la proyección.",
  "Proposed update": "Actualización propuesta",
  "Matched activity": "Actividad vinculada",
  "Needs PM decision": "Necesita decisión del PM",
  "No reliable activity match yet": "Todavía no hay una coincidencia confiable de actividad",
  "Installed quantity": "Cantidad instalada",
  "Linked records": "Registros vinculados",
  "Material movement": "Movimiento de materiales",
  "Outbound rows needing review": "Filas de salida que necesitan revisión",
  "Percent complete": "Porcentaje completado",
  "Explain the PM decision, supporting evidence, or why this stays deferred.": "Explique la decisión del PM, la evidencia de respaldo o por qué esto sigue diferido.",
  "Approve progress update": "Aprobar actualización de avance",
  "No proposed progress updates yet. Submit a Daily Report with work blocks to start review.": "Todavía no hay actualizaciones de avance propuestas. Envíe un Reporte Diario con bloques de trabajo para iniciar la revisión.",
  "Built from the approved schedule and rolling lookahead. Publishing today's plan does not change baseline or current schedule history.": "Construido a partir del cronograma aprobado y la anticipación móvil. Publicar el plan de hoy no cambia la historia del cronograma base ni del actual.",
  "Save day plan": "Guardar plan del día",
  "What changed between the two-week lookahead and today's plan?": "¿Qué cambió entre la anticipación de dos semanas y el plan de hoy?",
  ...
  "Driver taps create the live operating record.": "Los toques del conductor crean el registro operativo en vivo.",
  "Saved as typed text. This stays on the roster follow-up list until you either pick from the roster or add this person to the employee list.": "Guardado como texto escrito. Esto permanece en la lista de seguimiento del roster hasta que selecciones a la persona del roster o la agregues a la lista de empleados.",
  "Safety · Fleet Oversight": "Seguridad · Supervisión de flota",
  "Original incident record": "Registro original del incidente",
  "Not in roster — needs roster follow-up": "No está en el roster — necesita seguimiento del roster",
  "These remain the customer / contract approved record for this project only.": "Estos siguen siendo el registro aprobado del cliente / contrato solo para este proyecto.",
  "• Preserves bilingual field notes with an approved English copy for reporting": "• Conserva notas de campo bilingües con una copia en inglés aprobada para reportes",
  "Executive update": "Actualización ejecutiva",
  "This week's update": "Actualización de esta semana",
  "Generate Update": "Generar actualización",
  "No pulses generated yet. Press Generate Update to create the first.": "Aún no se han generado pulsos. Presiona Generar actualización para crear el primero.",
  "AI is not producing these numbers": "La IA no está produciendo estos números",
  "No limitations for value of work completed were published.": "No se publicaron limitaciones para el valor del trabajo completado.",
  ...
  "Executive Overview": "Resumen ejecutivo",
  "Executive Oversight": "Supervisión ejecutiva",
  "Start with the company-level picture, then open portfolio performance, immediate operations, or briefing readiness.": "Comienza con la vista general de la empresa y luego abre el desempeño del portafolio, las operaciones inmediatas o el estado del briefing.",
  "Operations Command Center": "Centro de mando de operaciones",
  "Immediate action right now": "Acción inmediata ahora mismo",
  "Open the live incident, constraint, and operational queues that need intervention now.": "Abre las colas en vivo de incidentes, restricciones y operaciones que necesitan intervención ahora.",
  "Executive Operations Dashboard": "Panel ejecutivo de operaciones",
  "What changed this period": "Qué cambió en este periodo",
  "Review operating volume, briefing readiness, and enterprise coordination trends for the selected period.": "Revisa el volumen operativo, el estado del briefing y las tendencias de coordinación empresarial para el periodo seleccionado.",
  "Cross-project cost and schedule risk": "Riesgo de costo y cronograma entre proyectos",
  "Use the section below to see which projects need leadership attention, why they moved, and what should happen next.": "Usa la sección siguiente para ver qué proyectos necesitan atención de liderazgo, por qué cambiaron y qué debe pasar después.",
  "Could not load portfolio performance.": "No se pudo cargar el desempeño del portafolio.",
  "Portfolio data refreshed.": "Los datos del portafolio se actualizaron.",
  "Could not refresh portfolio performance.": "No se pudo actualizar el desempeño del portafolio.",
  "Could not export portfolio performance.": "No se pudo exportar el desempeño del portafolio.",
  "Could not load your project portfolio.": "No se pudo cargar tu portafolio de proyectos.",
  "Project portfolio refreshed.": "Tu portafolio de proyectos se actualizó.",
  "Could not refresh your project portfolio.": "No se pudo actualizar tu portafolio de proyectos.",
  "Could not export your project portfolio.": "No se pudo exportar tu portafolio de proyectos.",
  "Projects Assigned to You": "Proyectos asignados a ti",
  "No recent field, safety, or shop activity reported yet.": "Aún no se reporta actividad reciente de campo, seguridad o taller.",
  "Your Project Portfolio": "Tu portafolio de proyectos",
  "Project Management Center": "Centro de gestión de proyectos",
  "See which of your projects need attention today and open the right record fast.": "Ve cuáles de tus proyectos necesitan atención hoy y abre rápidamente el registro correcto.",
  "Focused on": "Enfocado en",
  "PM Home": "Inicio PM",
  "Updated just now": "Actualizado justo ahora",
  "Back to project view": "Volver a la vista del proyecto",
  "These are the projects currently assigned to you.": "Estos son los proyectos que tienes asignados actualmente.",
  "All my projects": "Todos mis proyectos",
  "Open Project": "Abrir proyecto",
  "Missing Daily Report": "Informe diario faltante",
  "Open project": "Abrir proyecto",
  "Portfolio performance": "Desempeño del portafolio",
  "What needs attention": "Qué necesita atención",
  "Current portfolio condition": "Condición actual del portafolio",
  "See the total projects needing review first, then confirm whether cost, schedule, or current reporting is driving the risk.": "Primero mira el total de proyectos que necesitan revisión y luego confirma si el costo, el cronograma o los reportes actuales están impulsando el riesgo.",
  "These projects need leadership review because cost, schedule, commitments, or current reporting are not where they should be.": "Estos proyectos necesitan revisión de liderazgo porque el costo, el cronograma, los compromisos o los reportes actuales no están donde deberían estar.",
  "No scoped projects are currently asking for immediate portfolio intervention.": "Ningún proyecto dentro del alcance está pidiendo una intervención inmediata del portafolio.",
  "projects are on track": "proyectos están en camino",
  "Missing current information": "Falta información actual",
  "Refresh portfolio": "Actualizar portafolio",
  "2 · What changed": "2 · Qué cambió",
  "Recent changes across the portfolio": "Cambios recientes en el portafolio",
  "Review only the changes that materially moved a project or changed the current outlook.": "Revisa solo los cambios que movieron materialmente un proyecto o cambiaron la perspectiva actual.",
  "Recent project changes": "Cambios recientes del proyecto",
  "No material project changes were posted in this update.": "No se publicaron cambios materiales del proyecto en esta actualización.",
  "Cost and schedule measures": "Medidas de costo y cronograma",
  "Current reading": "Lectura actual",
  "3 · What should happen next": "3 · Qué debe pasar después",
  "Open the projects that need action": "Abre los proyectos que necesitan acción",
  "Search by project number or name, filter by business condition, then open the project record, forecast, or cost view.": "Busca por número o nombre del proyecto, filtra por condición del negocio y luego abre el registro del proyecto, el pronóstico o la vista de costos.",
  "Search by project number or name": "Buscar por número o nombre del proyecto",
  "project(s) shown": "proyecto(s) mostrados",
  "No scoped projects match the current filters.": "Ningún proyecto dentro del alcance coincide con los filtros actuales.",
  "4 · How performance is measured": "4 · Cómo se mide el desempeño",
  "Use these standards when you read the page": "Usa estas normas al leer la página",
  "Cost compares completed work value against actual cost. Schedule compares completed work value against planned work value. Mixed-unit production is never rolled into one false total.": "El costo compara el valor del trabajo completado contra el costo real. El cronograma compara el valor del trabajo completado contra el valor planificado. La producción con unidades mezcladas nunca se combina en un solo total falso.",
  "Measurement standards": "Normas de medición",
  "Portfolio cost and schedule ratios come from total dollar values. Project ratios are never averaged together.": "Las razones de costo y cronograma del portafolio salen de valores totales en dólares. Las razones de los proyectos nunca se promedian entre sí.",
  "Production quantities are only added when the unit matches. Unlike units stay separate.": "Las cantidades de producción solo se suman cuando la unidad coincide. Las unidades diferentes permanecen separadas.",
  "This page compares committed finish dates, likely finish dates, commitments, constraints, and current reporting without inventing a single false portfolio finish date.": "Esta página compara fechas comprometidas de terminación, fechas probables de terminación, compromisos, restricciones y reportes actuales sin inventar una sola fecha falsa de terminación del portafolio.",
  "Current reporting confidence": "Confianza de los reportes actuales",
  "Projects": "Proyectos",
  "Projects reporting": "Proyectos reportando",
  "Current reporting": "Reportes actuales",
  "Items needing review": "Elementos que necesitan revisión",
  "What needs leadership attention right now": "Qué necesita atención de liderazgo ahora mismo",
  "Start with the issues that need leadership action, then review what changed in the selected period and whether the enterprise briefing is ready to send.": "Empieza con los problemas que necesitan acción de liderazgo y luego revisa qué cambió en el periodo seleccionado y si el briefing empresarial está listo para enviarse.",
  "Use": "Usa",
  "for cross-project cost, schedule, commitments, and current reporting.": "para costo, cronograma, compromisos y reportes actuales entre proyectos.",
  "Loading the current operating picture…": "Cargando la vista operativa actual…",
  "Which projects are carrying the most operating friction": "Qué proyectos están cargando la mayor fricción operativa",
  "Delay, safety, and readiness issues that are rising to the top": "Problemas de demora, seguridad y preparación que están subiendo a la parte superior",
  "items need review": "elementos necesitan revisión",
  "Variance, recovery, and resource coordination that may require leadership intervention": "Variaciones, recuperación y coordinación de recursos que pueden requerir intervención de liderazgo",
  "Briefing readiness, approval state, and current summary lines": "Estado del briefing, estado de aprobación y líneas actuales del resumen",
  "No executive summary lines are published yet. Generate the latest briefing to build the current summary from operating records.": "Aún no se publican líneas del resumen ejecutivo. Genera el briefing más reciente para construir el resumen actual a partir de los registros operativos.",
  "Committed-vs-likely finish records are not ready yet.": "Los registros de terminación comprometida contra terminación probable aún no están listos.",
  "Commitment records are not ready yet.": "Los registros de compromisos aún no están listos.",
  "Constraint records are not ready yet.": "Los registros de restricciones aún no están listos.",
  "Resource pressure records are not ready yet.": "Los registros de presión de recursos aún no están listos.",
  "No material change was posted in this update.": "No se publicó un cambio material en esta actualización.",
  "Open project performance": "Abrir desempeño del proyecto",
  "Open forecast": "Abrir pronóstico",
  "Open cost and earned value": "Abrir costo y valor ganado",
  "Latest updates used here": "Últimas actualizaciones usadas aquí",
  "Committed finish": "Terminación comprometida",
  "day(s) later than commitment": "día(s) más tarde que el compromiso",
  "Commitments at risk": "Compromisos en riesgo",
  "Current cost and schedule picture": "Situación actual de costo y cronograma",
  "Current operational pressure": "Presión operativa actual",
  "Likely finish": "Terminación probable",
  "Open constraints": "Restricciones abiertas",
  "Resource shortages": "Faltantes de recursos",
  "Signal": "Señal",
  "Value": "Valor",
  "Approved Shift Story": "Resumen aprobado del turno",
  "Nine short steps. Dropdowns first. AI drafts the story of this shift from your field records. Save state, scope, and next action stay visible the whole time.": "Nueve pasos cortos. Primero los menús desplegables. La IA redacta la historia de este turno con sus registros de campo. El estado de guardado, el alcance y la siguiente acción permanecen visibles todo el tiempo.",
  "Daily report {{reportRef}} saved.": "Informe diario {{reportRef}} guardado.",
  "{{savedLabel}} Delivery is being tracked separately.": "{{savedLabel}} La entrega se está siguiendo por separado.",
  "{{savedLabel}} Delivery needs office follow-up, but the report is preserved.": "{{savedLabel}} La entrega necesita seguimiento de oficina, pero el informe queda preservado.",
  "{{savedLabel}} Email safely captured in Preview.": "{{savedLabel}} El correo se capturó de forma segura en Preview.",
  "{{savedLabel}} Project team email accepted.": "{{savedLabel}} El correo del equipo del proyecto fue aceptado.",
  "previous report": "informe anterior",
  "the previous report": "el informe anterior",
  "Certifications, training records, expirations, sign-in sheets, renewal reminders.": "Certificaciones, registros de capacitación, vencimientos, hojas de firma y recordatorios de renovación.",
  "Corrective Actions · Open": "Acciones correctivas · Abiertas",
  "Corrective Actions · Overdue": "Acciones correctivas · Vencidas",
  "Cross-portal accountability. Track corrective actions, follow-ups, deficiencies, approvals.": "Responsabilidad entre portales. Haga seguimiento de acciones correctivas, seguimientos, deficiencias y aprobaciones.",
  "Defects grouped by truck, driver notes, current status, severity context.": "Defectos agrupados por camión, notas del conductor, estado actual y contexto de severidad.",
  "Filter the 136-topic library, build a PDF pack for kickoffs and prep.": "Filtre la biblioteca de 136 temas y cree un paquete PDF para arranques y preparación.",
  "How-to guides, troubleshooting, and downloadable PDFs for Safety workflows.": "Guías prácticas, solución de problemas y PDF descargables para los flujos de Seguridad.",
  "Issuance, returns, damages, chargebacks. Per-employee chain of custody review.": "Entrega, devoluciones, daños y cargos. Revise la cadena de custodia por empleado.",
  "Monday email summarising open CAs, overdue items, recent incidents, expirations.": "Correo del lunes que resume acciones correctivas abiertas, elementos vencidos, incidentes recientes y vencimientos.",
  "Monthly inspections, due-date tracking, pass/fail records, per-unit history.": "Inspecciones mensuales, seguimiento de vencimientos, registros de aprobado/reprobado e historial por unidad.",
  "OSHA 300, insurance summaries, trend reports, executive roll-ups, project flags.": "OSHA 300, resúmenes de seguros, reportes de tendencias, resúmenes ejecutivos y alertas de proyecto.",
  "OSHA, SDS, emergency action plans, competent-person docs, fall-protection records.": "OSHA, SDS, planes de acción de emergencia, documentos de persona competente y registros de protección contra caídas.",
  "Open, investigate, verify, close. Linked to incidents, audits, training.": "Abrir, investigar, verificar y cerrar. Vinculado con incidentes, auditorías y capacitación.",
  "Per-employee training, certs, meetings, incidents, retraining, PPE issuance.": "Capacitación, certificaciones, reuniones, incidentes, recapacitación y entrega de EPP por empleado.",
  "Review every job-site inspection. Filter, search, drill in, or start new.": "Revise cada inspección del sitio. Filtre, busque, profundice o comience una nueva.",
  "Safety summary": "Resumen de seguridad",
  "Serialized / recoverable PPE issued more than 90 days ago without a return logged. Consumable PPE excluded.": "EPP serializado o recuperable entregado hace más de 90 días sin devolución registrada. Se excluye el EPP consumible.",
  "Severity-tagged review of every field report. Filter by project, employee, date.": "Revisión con severidad de cada reporte de campo. Filtre por proyecto, empleado o fecha.",
  "Supporting tools, how-to guides, and cross-portal integration visibility": "Herramientas de apoyo, guías prácticas y visibilidad de integraciones entre portales",
  "Training certifications, competent-person docs, fall protection, CPR/First Aid windows.": "Certificaciones de capacitación, documentos de persona competente, protección contra caídas y ventanas de RCP/Primeros Auxilios.",
  "Update your Safety Portal password. Required after a temp-password issue.": "Actualice la contraseña de su Portal de Seguridad. Requerido después de un problema con contraseña temporal.",
  "A corrective action cannot move directly from Pending Review to Closed. It must pass through Verified — a separate review step that confirms the corrective work actually happened. The verifier is stamped onto the record.": "Una acción correctiva no puede pasar directamente de Pendiente de revisión a Cerrada. Debe pasar por Verificada, un paso aparte que confirma que el trabajo correctivo sí ocurrió. La persona verificadora queda registrada en el expediente.",
  "Corrective Actions Lifecycle": "Ciclo de vida de las acciones correctivas",
  "Open and Verified corrective actions surface on the PM Crew Compliance lens, HR Accountability Timeline, the standards dashboard, and Compliance Findings. Closed records remain in the audit trail forever.": "Las acciones correctivas Abiertas y Verificadas aparecen en el lente de Cumplimiento de Cuadrillas de PM, la Línea de Tiempo de Responsabilidad de RH, el panel de estándares y los Hallazgos de Cumplimiento. Los registros cerrados permanecen para siempre en la pista de auditoría.",
  "Open corrective actions that never close are silent operational debt. Severe incidents without a linked corrective action are surfaced on the standards dashboard. Every status change is appended to the history for OSHA / DOT / insurance review.": "Las acciones correctivas abiertas que nunca se cierran son deuda operativa silenciosa. Los incidentes graves sin una acción correctiva vinculada aparecen en el panel de estándares. Cada cambio de estado se agrega al historial para revisión de OSHA / DOT / seguros.",
  "Safety leads corrective action handling — create, edit, advance, verify, and close. HR adds labor and accountability notes only. PM and Field Leadership can read records affecting their crews. Admin keeps supervisory access.": "Seguridad lidera la gestión de acciones correctivas: crear, editar, avanzar, verificar y cerrar. RH solo agrega notas laborales y de responsabilidad. PM y Liderazgo de Campo pueden leer los registros que afectan a sus cuadrillas. Admin conserva acceso de supervisión.",
  "Open Asset Thread": "Abrir hilo del activo",
  "Source": "Origen",
  "Upload": "Subir",
  "Supervisor best practices": "Hábitos recomendados del supervisor",
};
