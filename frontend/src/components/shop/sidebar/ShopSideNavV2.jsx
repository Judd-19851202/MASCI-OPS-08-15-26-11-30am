...
export default function ShopSideNavV2({ onNavigate }) {
  ...
  return (
    <nav className="space-y-3 p-3 glass-blur glass-bg glass-dark elite-glass-sidebar rounded-[1.75rem]" data-testid="shop-side-nav-v2">
      ...
      <div className="pt-3 mt-3 border-t border-slate-700/70 space-y-0.5" data-testid="shop-nav-v2-footer-rail">
