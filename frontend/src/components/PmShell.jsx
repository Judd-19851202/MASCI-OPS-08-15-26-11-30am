...
export default function PmShell({
  ...
  return (
    <PortalShell
      ...
      subtitle={subtitle ? t(subtitle) : t("Project execution, blockers, due work, and field coordination in one canonical shell.")}
      sideNav={<SideNavV2 />}
      onSignOut={signOut}
      experienceTone="pm"
      ...
      <div className="space-y-5" data-testid="pm-section-body">
        ...
        {section !== "overview" && (
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              <span className="inline-flex items-center gap-2"><LayoutDashboard className="w-4 h-4" /> {t("Back to PM Overview")}</span>
            </Link>
          </div>
        )}
