    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-5 sm:px-8 py-12">
        ...
        >
          ...
          <div className="mt-8 pt-5 border-t-2 border-slate-100 font-mono text-[10px] uppercase tracking-[0.25em] text-red-700 font-bold flex items-center justify-center gap-3">
