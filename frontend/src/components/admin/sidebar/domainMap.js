...
import {
  Activity, Users, Wrench, Mail, ClipboardCheck, Shield, ShieldCheck,
...
export const DOMAINS_V2 = [
  ...
  },
  {
    ...
    routes: [
      ...
      { to: "/admin/governance/project-controls/earned-value", label: "Earned Value Engine", desc: "BAC · PV · EV · AC · CPI · SPI", icon: ChartBar },
