...
export const DOMAINS_V3 = [
  ...
  // here. This is the platform's operating system view.
  {
    ...
    visibleRoutes: [
      ...
      { to: "/admin/governance-trust",         label: "Governance & Trust",     desc: "Certification · deploy readiness · rules.",               icon: ShieldCheck,   keywords: ["governance", "trust", "certification", "compliance"] },
