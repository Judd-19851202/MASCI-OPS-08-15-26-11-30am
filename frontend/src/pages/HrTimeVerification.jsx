  ...
  return (
    ...
    >
      ...
      <Card className="p-4 mb-5 border-2 border-purple-200 bg-purple-50/30">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-x-4 gap-y-3 items-end">
          <div>
      ...
      {/* Stats strip */}
      <div className="grid grid-cols-2 md:grid-cols-5 gap-x-4 gap-y-3 mb-5" data-testid="hr-tv-stats-strip">
        {stats.map((s) => (
