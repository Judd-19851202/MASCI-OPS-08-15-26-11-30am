...
export default function Hub() {
  ...
  return (
    <div className="min-h-screen blueprint-bg">
      ...
      <footer className="max-w-6xl mx-auto px-5 sm:px-8 py-8 flex flex-col sm:flex-row items-center justify-between gap-3 font-mono text-xs uppercase tracking-[0.2em] text-slate-500">
        <span>{t("MASCI · Job Site Safety Program")}</span>
        <Link
          to="/admin/login"
