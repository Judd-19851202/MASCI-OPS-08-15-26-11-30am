...
export default function SafetyChangePassword() {
  ...
  return (
    <PortalLoginShell
      homeLink="/safety-portal"
      headerBorderClass="border-cyan-700"
      backHoverClass="hover:text-cyan-300"
      backTestId="safety-change-pw-back"
      rootTestId="safety-change-pw-page"
      ...
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-md p-7 sm:p-9 shadow-xl">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <h1 className="font-display text-2xl font-black text-slate-900 leading-none mt-1" data-testid="safety-change-pw-title">
              {t("Choose your password")}
            </h1>
          </div>
        </div>
        {me && (
          <p className="text-slate-600 text-sm mb-1" data-testid="safety-change-pw-identity">
        ...
        <form onSubmit={onSubmit} className="space-y-4" data-testid="safety-change-pw-form">
          <div>
            ...
            <PasswordInput
              ...
              toggleTestId="safety-change-pw-old-toggle"
            />
          </div>
          <div>
            <Label className="font-mono text-[10px] uppercase tracking-[0.2em] text-slate-700">
            ...
            <PasswordInput
              ...
              toggleTestId="safety-change-pw-new-toggle"
            />
          </div>
          <div>
            <Label className="font-mono text-[10px] uppercase tracking-[0.2em] text-slate-700">
            ...
            <PasswordInput
              ...
              toggleTestId="safety-change-pw-confirm-toggle"
            />
          </div>
          <Button
            type="submit"
