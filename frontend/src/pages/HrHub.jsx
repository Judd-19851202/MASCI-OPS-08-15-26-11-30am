...
const TILES = [
  ...
  { to: "/hr/field-leadership-users", icon: KeyRound, label: "Field Leadership Users",
    desc: "Manage MASCI Field Leadership Portal accounts · issue per-user passwords · reset / deactivate · governed identity (iter314)",
