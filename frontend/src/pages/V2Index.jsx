...
const PREVIEW_LANES = [
  ...
  },
  {
    ...
    summary: "Track 13.6G preview lane — Dispatch Hub V2 live at /dispatch-portal/hub_v2. Fed by real /api/dispatch/command/summary, 14 action queues across drivers/haul/fleet/shop/safety, every card opens an existing dispatch surface. MapLibre command map preserved at /dispatch-portal/command (zero visual drift).",
  },
  {
    id: "safety-v2",
    portal: "Safety",
  ...
  },
  {
    ...
    builtOn: "2026-06-12",
    status: "operational",
    score: { powerful: 9, simple: 10, beautiful: 10, trusted: 9, proven: 8 },
    previewTo: "/driver/hub_v2",
    compareTo: null,
    currentTo: "/driver",
    summary: "Track 13.6J preview — single-action lane at /driver/hub_v2. ≤ 2 taps · ≤ 30 seconds · one big primary button. Real source: /api/dispatch/driver/my-assignment. Classic tap-and-work surface remains at /driver.",
  },
];
