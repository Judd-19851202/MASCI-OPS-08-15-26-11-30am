                ...
                <table className="w-full text-sm">
                  <thead className="bg-slate-50 border-b-2 border-slate-200">
                    <tr className="text-left">
                      <th className="px-3 py-2 font-mono text-[10px] uppercase tracking-[0.2em] text-slate-500">
                        Date
                      </th>
                      <th className="px-3 py-2 font-mono text-[10px] uppercase tracking-[0.2em] text-slate-500">
                        Kind
                      ...
                      <th className="px-3 py-2 font-mono text-[10px] uppercase tracking-[0.2em] text-slate-500 text-right">
                        Pass / Fail / N/A
                      </th>
                      <th className="px-3 py-2 font-mono text-[10px] uppercase tracking-[0.2em] text-slate-500 text-right">
                        Photos
                    ...
                    {filtered.map((r) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2 text-right tabular-nums">
                          <span className="text-emerald-700">{r.pass_count}</span>{" "}
                          /{" "}
