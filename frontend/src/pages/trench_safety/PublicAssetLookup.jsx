...
export default function PublicAssetLookup({ compact = false }) {
  ...
  return (
    <form onSubmit={submit} className={compact ? "" : "bg-white border border-slate-200 rounded-md p-4"} data-testid="public-asset-lookup">
      {!compact && (
      ...
      <div className="flex items-stretch gap-2">
        ...
        <button
          ...
          className="bg-cyan-700 hover:bg-cyan-800 disabled:bg-slate-300 text-white font-bold uppercase tracking-[0.12em] text-xs px-4 inline-flex items-center gap-1 rounded"
        >
