...
export default function ExecutiveOverview() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm" data-testid="executive-forecasting-launch-card">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500">WP-18C7</div>
            <div className="mt-1 text-lg font-semibold text-slate-900">{t("Forecasting & Commitments")}</div>
            <div className="mt-1 text-sm text-slate-600">{t("Open the governed C7 workspace for likely finish, pace, commitment exposure, and explainable change detection.")}</div>
          </div>
          <Link to="/admin/governance/project-controls/forecasting" className="inline-flex items-center rounded-full border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-50" data-testid="executive-forecasting-launch-link">
            {t("Open C7 workspace")} →
          </Link>
        </div>
      </div>
      <div className="mb-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm" data-testid="executive-earned-value-launch-card">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <div className="mt-1 text-lg font-semibold text-slate-900">{t("Earned Value")}</div>
            <div className="mt-1 text-sm text-slate-600">{t("Open the C8 job view for budget, earned progress, cost, forecast impact, and any data still waiting on review.")}</div>
          </div>
