  ...
  return (
    <div className="min-h-screen blueprint-bg">
      ...
      <footer className="max-w-6xl mx-auto px-5 sm:px-8 py-8 text-center font-mono text-xs uppercase tracking-[0.2em] text-slate-500 border-t-2 border-slate-200">
        {t("MASCI · Field · No Guesswork. No Missed Steps. No Excuses.")}
      </footer>
    </div>
  );
}
...
function AggregatePanel({ lang, t }) {
  ...
  return (
    <section className="bg-white border-2 border-slate-300 rounded-md p-5 sm:p-7" data-testid="calc-panel-aggregate">
      ...
      {result && (
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mt-6" data-testid="agg-results">
...
function AsphaltPanel({ lang, t }) {
  ...
  return (
    <section className="bg-white border-2 border-slate-300 rounded-md p-5 sm:p-7" data-testid="calc-panel-asphalt">
      ...
      {result && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6" data-testid="asp-results">
...
function ConcretePanel({ lang, t }) {
  ...
  return (
    <section className="bg-white border-2 border-slate-300 rounded-md p-5 sm:p-7" data-testid="calc-panel-concrete">
      ...
      {result && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6" data-testid="con-results">
...
function TruckLoadPanel({ lang, t }) {
  ...
  return (
    <section className="bg-white border-2 border-slate-300 rounded-md p-5 sm:p-7" data-testid="calc-panel-truck-load">
      ...
      {result && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6" data-testid="tl-results">
...
function YieldWastePanel({ lang, t }) {
  ...
  return (
    <section className="bg-white border-2 border-slate-300 rounded-md p-5 sm:p-7" data-testid="calc-panel-yield-waste">
      ...
      {result && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6" data-testid="yw-results">
...
function ConversionPanel({ lang, t }) {
  ...
  return (
    <section className="bg-white border-2 border-slate-300 rounded-md p-5 sm:p-7" data-testid="calc-panel-conversion">
      ...
      {result && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6" data-testid="conv-results">
