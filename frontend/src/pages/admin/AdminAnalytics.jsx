...
export default function AdminAnalytics() {
  ...
  return (
    <AdminShell title="Usage Analytics" kicker="ADMIN · OPERATIONAL INSIGHT">
      ...
      {/* ── KPI row ──────────────────────────────────────────── */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 mb-5" data-testid="analytics-kpis">
      ...
      <Panel title="By portal" className="mb-5">
        {portals.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3" data-testid="analytics-portals">
            {portals.map((p) => (
