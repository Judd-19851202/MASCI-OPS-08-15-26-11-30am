      ...
      {preview && !result && (
        <>
          <Card className="p-4 mb-4 border-2 border-purple-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-x-4 gap-y-3 text-center" data-testid="dqi-summary-strip">
              {[
      ...
      {result && (
        <Card className="p-6 mb-5 border-2 border-emerald-400 bg-emerald-50/40" data-testid="dqi-result-card">
          <div className="flex flex-col items-center text-center gap-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-x-4 gap-y-3 mt-2 w-full max-w-3xl">
              {[
