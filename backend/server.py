...
async def admin_backups_scheduler_state(_: bool = Depends(require_admin_strict)):
    ...
    return {
        ...
        "r2_hourly_requested": state.get("r2_hourly_requested"),
        "r2_hourly_effective": state.get("r2_hourly_effective"),
        "r2_hourly_locked_off": state.get("r2_hourly_locked_off"),
        "hourly_cadence_enabled": state.get("hourly_cadence_enabled"),
        "activation_blockers": state.get("activation_blockers"),
        "activation_status": state.get("activation_status"),
        "activation_environment": state.get("activation_environment"),
        "last_activation_evaluated_at": state.get("last_activation_evaluated_at"),
        "next_eligible_hourly_slot": state.get("next_eligible_hourly_slot"),
        "scheduler": state,
...
app.include_router(_operational_health_make_router(db, require_admin_strict))
...
_pm_router = build_pm_router(
    ...
    login_deps={
        ...
        "is_test_request_fn": _is_test_request,
