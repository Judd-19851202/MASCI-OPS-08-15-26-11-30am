...
@pytest.mark.parametrize("track,lang,expected_phrase", [
    ("field", "en", "Generated through MASCI Operations Platform — Powered by ForgedOps™ | © 2026 ForgedOps™"),
    ("field", "es", "Generado a través de MASCI Operations Platform — Desarrollado por ForgedOps™ | © 2026 ForgedOps™"),
    ("shop", "en", "Generated through MASCI Operations Platform — Powered by ForgedOps™ | © 2026 ForgedOps™"),
    ("pm", "en", "Generated through MASCI Operations Platform — Powered by ForgedOps™ | © 2026 ForgedOps™"),
    ("admin", "en", "Generated through MASCI Operations Platform — Powered by ForgedOps™ | © 2026 ForgedOps™"),
])
