...
FOOTER_ES_FRAGMENT_VARIANTS = [
    "Generado a través de MASCI HUB — Desarrollado por ForgedOps™ | © 2026 ForgedOps™",
    "Generated through MASCI HUB — Powered by ForgedOps™ | © 2026 ForgedOps™",  # bilingual may include EN too
]
