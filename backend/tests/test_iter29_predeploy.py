...
FOOTER_ES_FRAGMENT_VARIANTS = [
    "Generado a través de MASCI Operations Platform — Desarrollado por ForgedOps™ | © 2026 ForgedOps™",
    "Generated through MASCI Operations Platform — Powered by ForgedOps™ | © 2026 ForgedOps™",  # bilingual may include EN too
]
