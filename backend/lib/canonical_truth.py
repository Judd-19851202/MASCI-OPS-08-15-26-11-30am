...
_SURFACES: Dict[str, TruthSurface] = {
    ...
    "enterprise_governance_registry": TruthSurface(
        surface_id="enterprise_governance_registry",
        surface_name="Enterprise Governance Registry",
        role=CANONICAL_OWNER,
        owner_type="authoritative",
        canonical_owner_id="enterprise_governance_registry",
        upstream_owner_ids=[],
        owner_endpoint="/api/admin/governance/registry",
        owner_module="backend/services/enterprise_governance.py",
        truth_subject="enterprise_governance_authority",
        status_authority="enterprise_governance_registry",
        kpi_authority="enterprise_governance_registry",
        threshold_authority="enterprise_governance_registry",
        freshness_authority="enterprise_governance_registry",
        evidence_sources=[
            "enterprise_governance_registry",
            "enterprise_governance policies",
            "enterprise_governance approval flows",
        ],
        derived_fields=["roles", "permissions", "policies", "constitutional_principles"],
        derivation_formula="direct_registry_projection",
        allowed_status_outputs=[VERIFIED, DEGRADED, MISMATCH, UNVERIFIABLE],
        operator_surfaces=[
            "frontend/src/pages/admin/AdminGovernanceOperatingSystem.jsx",
            "frontend/src/pages/admin/AdminGovernanceRegistryPage.jsx",
        ],
        environment_scope="preview_and_production",
        runtime_reachability="reachable",
        production_reachability="reachable",
        ...
        contract_version=CONTRACT_VERSION,
        deprecation_state="active",
        audit_reference="C2-ENTERPRISE-GOVERNANCE-REGISTRY",
        contract="Canonical authority for enterprise governance roles, permissions, policies, and constitutional principles.",
        ui_consumer_routes=["/admin/governance", "/admin/governance/registry", "/admin/governance/roles", "/admin/governance/policies"],
    ),
    "enterprise_governance_health_module": TruthSurface(
        surface_id="enterprise_governance_health_module",
        surface_name="Operational Health Dashboard · Enterprise Governance Module",
        role=AGGREGATOR,
        owner_type="derived",
        canonical_owner_id="enterprise_governance_registry",
        upstream_owner_ids=["enterprise_governance_registry", "trust_spine", "platform_attestation"],
        owner_endpoint="/api/admin/operational-health/modules/enterprise-governance",
        owner_module="backend/routes/admin_operational_health.py",
        truth_subject="enterprise_governance_health_module",
        status_authority="derived_from_upstream_owners_and_repository_artifacts",
        kpi_authority="per_kpi_evidence_source",
        threshold_authority="enterprise_governance_health_module",
        freshness_authority="enterprise_governance_health_module",
        evidence_sources=[
            ...
            "backend/tools/wp15_governance_convergence_scan.py",
            ".github/workflows/ci.yml",
            ".github/workflows/sigma3-deploy-gate.yml",
            "WP-15 architecture and certification artifacts",
        ],
        derived_fields=["overall_status", "section_statuses", "kpi_cards", "module_catalog"],
        derivation_formula="fresh_endpoint_fanout_plus_repository_artifact_validation_with_truthful_unknown_on_missing_or_stale_evidence",
        allowed_status_outputs=[VERIFIED, DEGRADED, MISMATCH, UNVERIFIABLE],
        operator_surfaces=["frontend/src/pages/admin/AdminGovernanceOperatingSystem.jsx"],
        environment_scope="preview_and_production",
        runtime_reachability="reachable",
        production_reachability="reachable",
        registered_at="2026-07-29T00:00:00Z",
        contract_version=CONTRACT_VERSION,
        deprecation_state="active",
        audit_reference="C2-WP15-OPERATIONAL-HEALTH",
        contract="Derived operational health consumer for Enterprise Governance. Never authoritative over child business logic, policy evaluation, or source truth.",
        ui_consumer_routes=["/admin/governance"],
        notes=[
            "Enterprise Governance is the first module on the shared Operational Health Dashboard framework.",
            "Additional constitutional systems must plug into this framework without creating duplicate status engines.",
        ],
    ),
