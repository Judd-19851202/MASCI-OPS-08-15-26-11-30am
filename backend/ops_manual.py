...
SECTIONS: List[Tuple[str, List[Block]]] = [
    ...
    ("3. Third-Party / Supporting Systems", [
        ...
        ("table",
            ...
            [
                ...
                ["Customer Assets CDN", "Asset hosting for training videos (current provider = platform-hosted asset storage)", "Video URLs registered in training_videos Mongo doc", "MEDIUM — videos are non-blocking; replaceable with any HTTPS MP4 host"],
            ]),
    ]),
    ...
    ("5. Deployment & Environments", [
        ...
        ("h3", "Rollback"),
        "Use the Rollback option in the deployment dashboard to return to the previous checkpoint. This reverts code ONLY — if data changed between deploy and rollback, restore the pre-deploy backup from Step 1 above.",
    ]),
    ...
    ("6. Backup & Recovery", [
        ...
        ("list", [
            ...
            "STEP 4 — Update MONGO_URL in the deploy env vars to point at the new cluster.",
    ...
    ("9. Failure Points", [
        ("table",
            ...
            [
                ...
                ["ADMIN_PASSWORD forgotten", "No one can access Admin Hub", "HIGH — can't do master-list edits or backups", "Login returns 401 on valid admin page", "Change ADMIN_PASSWORD in deploy env vars → redeploy."],
