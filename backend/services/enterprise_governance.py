...
def build_enterprise_governance_registry() -> Dict[str, Any]:
    permissions = {
        ...
        "field_memory.read": {"label": "Read Field Memory", "domain": "field_memory", "action": "read"},
        "field_memory.write.project": {"label": "Write Project Field Memory", "domain": "field_memory", "action": "write_project"},
        "field_memory.write.equipment": {"label": "Write Equipment Field Memory", "domain": "field_memory", "action": "write_equipment"},
        "field_memory.write.assignment": {"label": "Write Assignment Field Memory", "domain": "field_memory", "action": "write_assignment"},
        "field_memory.write.recovery_event": {"label": "Write Recovery Event Field Memory", "domain": "field_memory", "action": "write_recovery_event"},
        "photo_governance.read": {"label": "Read Photo Governance", "domain": "photo_governance", "action": "read"},
        "photo_governance.manage": {"label": "Manage Photo Governance", "domain": "photo_governance", "action": "manage"},
        "operational_constraints.read": {"label": "Read Operational Constraints", "domain": "operational_constraints", "action": "read"},
        "operational_constraints.manage": {"label": "Manage Operational Constraints", "domain": "operational_constraints", "action": "manage"},
        "document_expirations.read": {"label": "Read Document Expirations", "domain": "document_expirations", "action": "read"},
        "document_expirations.manage": {"label": "Manage Document Expirations", "domain": "document_expirations", "action": "manage"},
        "document_expirations.read.employee": {"label": "Read Employee Expirations", "domain": "document_expirations", "action": "read_employee"},
        "document_expirations.read.training_cert": {"label": "Read Training Certificate Expirations", "domain": "document_expirations", "action": "read_training_cert"},
        "document_expirations.read.safety": {"label": "Read Safety Expirations", "domain": "document_expirations", "action": "read_safety"},
        "document_expirations.read.equipment": {"label": "Read Equipment Expirations", "domain": "document_expirations", "action": "read_equipment"},
        "document_expirations.read.project": {"label": "Read Project Expirations", "domain": "document_expirations", "action": "read_project"},
        "document_expirations.read.company": {"label": "Read Company Expirations", "domain": "document_expirations", "action": "read_company"},
        "employee_records.read.hr": {"label": "Read HR Employee Records", "domain": "employee_records", "action": "read_hr_lane"},
        "employee_records.read.safety": {"label": "Read Safety Employee Records", "domain": "employee_records", "action": "read_safety_lane"},
        "employee_records.read.asset": {"label": "Read Asset Employee Records", "domain": "employee_records", "action": "read_asset_lane"},
        "employee_records.read.corporate_import": {"label": "Read Corporate Import Employee Records", "domain": "employee_records", "action": "read_corporate_import_lane"},
        "employee_records.read.vendor": {"label": "Read Vendor Employee Records", "domain": "employee_records", "action": "read_vendor_lane"},
        "employee_records.approve.hr": {"label": "Approve HR Employee Records", "domain": "employee_records", "action": "approve_hr_lane"},
        "employee_records.approve.safety": {"label": "Approve Safety Employee Records", "domain": "employee_records", "action": "approve_safety_lane"},
        "employee_records.approve.asset": {"label": "Approve Asset Employee Records", "domain": "employee_records", "action": "approve_asset_lane"},
        "employee_records.approve.corporate_import": {"label": "Approve Corporate Import Employee Records", "domain": "employee_records", "action": "approve_corporate_import_lane"},
        "employee_records.approve.vendor": {"label": "Approve Vendor Employee Records", "domain": "employee_records", "action": "approve_vendor_lane"},
        "employee_lifecycle.manage": {"label": "Manage Employee Lifecycle", "domain": "employee_lifecycle", "action": "manage"},
        "transportation_dispatch_gate.preview": {"label": "Preview Transportation Dispatch Gate", "domain": "transportation_dispatch_gate", "action": "preview"},
        "transportation_dispatch_gate.override": {"label": "Override Transportation Dispatch Gate", "domain": "transportation_dispatch_gate", "action": "override"},
        "asset_documents.read": {"label": "Read Asset Documents", "domain": "asset_documents", "action": "read"},
        "asset_documents.manage": {"label": "Manage Asset Documents", "domain": "asset_documents", "action": "manage"},
        "asset_documents.delete": {"label": "Delete Asset Documents", "domain": "asset_documents", "action": "delete"},
    }
    roles = {
        ...
        "executive": {
            ...
            "permissions": [
                ...
                "evidence.export",
                "field_memory.read",
                "photo_governance.read",
                "photo_governance.manage",
                "operational_constraints.read",
                "operational_constraints.manage",
                "document_expirations.read",
                "document_expirations.manage",
                "document_expirations.read.employee",
                "document_expirations.read.training_cert",
                "document_expirations.read.safety",
                "document_expirations.read.equipment",
                "document_expirations.read.project",
                "document_expirations.read.company",
                "employee_records.read.hr",
                "employee_records.read.safety",
                "employee_records.read.asset",
                "employee_records.read.corporate_import",
                "employee_records.read.vendor",
        ...
        "project_manager": {
            ...
            "permissions": [
                ...
                "notification.ack",
                "field_memory.read",
                "field_memory.write.project",
                "field_memory.write.equipment",
                "field_memory.write.assignment",
                "field_memory.write.recovery_event",
                "photo_governance.read",
                "photo_governance.manage",
                "operational_constraints.read",
                "operational_constraints.manage",
        ...
        "hr": {
            ...
            "permissions": ["daily_reports.read", "admin_reporting.view", "audit.view", "notification.ack", "task.read", "operations_center.view", "cost_codes.read", "po_requests.read", "po_requests.approve", "po_requests.close", "po_requests.cancel", "global_search.use", "field_memory.read", "photo_governance.read", "photo_governance.manage", "operational_constraints.read", "operational_constraints.manage", "document_expirations.read", "document_expirations.manage", "document_expirations.read.employee", "document_expirations.read.training_cert", "employee_records.read.hr", "employee_records.read.safety", "employee_records.read.asset", "employee_records.read.corporate_import", "employee_records.read.vendor", "employee_records.approve.hr", "employee_records.approve.safety", "employee_records.approve.asset", "employee_records.approve.corporate_import", "employee_records.approve.vendor", "employee_lifecycle.manage"],
            "authority_level": "department",
        },
        "safety": {
            "label": "Safety",
            "portal_hints": ["safety", "admin"],
            "permissions": ["daily_reports.read", "operational_case.read", "notification.ack", "evidence.export", "task.read", "operations_center.view", "safety.read", "po_requests.submit", "po_requests.read", "global_search.use", "field_memory.read", "field_memory.write.project", "field_memory.write.equipment", "field_memory.write.assignment", "field_memory.write.recovery_event", "photo_governance.read", "photo_governance.manage", "operational_constraints.read", "operational_constraints.manage", "document_expirations.read", "document_expirations.manage", "document_expirations.read.employee", "document_expirations.read.training_cert", "document_expirations.read.safety", "employee_records.read.safety", "employee_records.approve.safety"],
            "authority_level": "department",
        },
        "shop": {
            "label": "Shop",
            "portal_hints": ["shop", "admin"],
            "permissions": ["task.read", "task.assign", "task.close", "notification.ack", "operations_center.view", "po_requests.submit", "po_requests.read", "po_requests.receipt.upload", "global_search.use", "field_memory.read", "field_memory.write.equipment", "field_memory.write.recovery_event", "photo_governance.read", "operational_constraints.read", "document_expirations.read", "document_expirations.manage", "document_expirations.read.equipment", "transportation_dispatch_gate.preview"],
            "authority_level": "department",
        },
        "dispatch": {
            "label": "Dispatcher",
            "portal_hints": ["dispatch", "admin"],
            "permissions": ["notification.ack", "task.read", "task.assign", "operations_center.view", "global_search.use", "field_memory.read", "field_memory.write.assignment", "field_memory.write.recovery_event", "photo_governance.read", "operational_constraints.read", "document_expirations.read", "document_expirations.read.equipment"],
            "authority_level": "department",
        },
        "field_leadership": {
            "label": "Field Leadership",
            "portal_hints": ["field_leadership", "admin"],
            "permissions": ["daily_reports.read", "notification.ack", "task.read", "po_requests.read", "po_requests.submit", "po_requests.receipt.upload", "global_search.use", "field_memory.read", "field_memory.write.project", "field_memory.write.equipment", "field_memory.write.assignment", "field_memory.write.recovery_event", "photo_governance.read", "photo_governance.manage", "operational_constraints.read", "operational_constraints.manage", "document_expirations.read", "document_expirations.manage", "document_expirations.read.project", "document_expirations.read.company"],
            "authority_level": "project",
        },
        "asset_admin": {
            "label": "Asset Administrator",
            "portal_hints": ["shop", "admin"],
            "permissions": ["employee_records.read.asset", "employee_records.approve.asset", "asset_documents.read", "asset_documents.manage"],
            "authority_level": "department",
        },
    }
    policies = {
