...
AGENTS: Dict[str, Dict[str, Any]] = {
    "day_narrative": {
        ...
        "system": _STRICTNESS + (
            ...
            "· Subcontractors & vendors (subcontractors): company, trade/scope, headcount, "
            ...
            "· Photo evidence: use photo_captions when they add grounded context, and weave photo_observations into the "
            ...
            "· Location context from gps_location when present.\n"
