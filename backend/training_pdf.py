...
FIELD_LESSONS = [
    ...
    },
    {
        "slug": "field-05-jha",
        "order": 5,
        "title": "Lesson 5 — Job Hazard Analysis (JHA)",
        "title_es": "Lección 5 — Análisis de Peligros del Trabajo (JHA)",
        "why": "MASCI Job Hazard Analyses are built before work begins by the Safety Department, Project Managers, and leadership — based on scope of work, site conditions, traffic control (MOT), environmental factors, and known project hazards. Hazards are identified and controlled BEFORE crews step onto the job. A properly built JHA is one of the strongest tools we have to prevent incidents.",
        "why_es": "Los JHAs de MASCI se preparan antes de que comience el trabajo, por el Departamento de Seguridad, los Gerentes de Proyecto y el liderazgo — basados en el alcance, condiciones del sitio, control de tráfico (MOT), factores ambientales y peligros conocidos del proyecto. Los peligros se identifican y controlan ANTES de que la cuadrilla pise el sitio. Un JHA bien hecho es una de las mejores herramientas para prevenir incidentes.",
        "steps": [
            "Crews do NOT build JHAs. JHAs are job-specific documents prepared in advance by Safety, PMs, and senior leadership.",
            "Each JHA covers project-wide hazards, locations by station number, required controls, environmental + site-specific risks, MOT hazards, and equipment/operational hazards.",
            "Every JHA package includes two documents: (1) JHA Document — full list of hazards, locations by station, required controls and safe practices; (2) Hazard Worksheet — hazard type, threat level, exact location, required controls, additional notes.",
            "Before starting work: review the JHA, understand the hazards in your work area, and follow every listed control.",
        ...
        "steps_es": [
            "Las cuadrillas NO crean JHAs. Los JHAs son documentos del proyecto preparados con anticipación por Seguridad, PMs y el liderazgo.",
            "Cada JHA cubre los peligros del proyecto, ubicaciones por número de estación, controles requeridos, riesgos ambientales y del sitio, peligros de MOT y peligros del equipo/operación.",
            "Cada paquete JHA incluye dos documentos: (1) Documento JHA — lista completa de peligros, ubicaciones por estación, controles requeridos y prácticas seguras; (2) Hoja de Peligros — tipo de peligro, nivel de amenaza, ubicación exacta, controles requeridos, notas adicionales.",
            "Antes de comenzar: revise el JHA, entienda los peligros de su área, y siga cada control listado.",
        ...
        "tips": [
            "The JHA exists so every crew member understands the risks BEFORE they encounter them. Use it, follow it, and speak up if something doesn't match.",
            "Stop Work Authority: every crew member has it. No questions, no discipline — if conditions on the ground don't match the JHA, stop.",
        ],
        "tips_es": [
            "El JHA existe para que cada miembro entienda los riesgos ANTES de encontrarlos. Úselo, sígalo, y hable si algo no coincide.",
            "Autoridad para Suspender el Trabajo: cada miembro la tiene. Sin preguntas, sin disciplina — si las condiciones no coinciden con el JHA, pare.",
        ],
        "cheatSheet": [
            "JHAs are pre-built by Safety / PM / Leadership — not the crew.",
            "Two docs per job: JHA + Hazard Worksheet (with station numbers).",
