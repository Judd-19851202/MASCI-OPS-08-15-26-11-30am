...
TRACKS = {
    ...
    "hr": {
        ...
        "blurb": "Read-only HR access — Field Leadership records, employee accountability, payroll-time verification, Exact CSV variance, training compliance.",
        "blurb_es": "Acceso HR de solo lectura — registros de Liderazgo, responsabilidad, verificación de tiempo, variación Exact, capacitación.",
        "accent": "#6D28D9",
    },
}
...
ADMIN_LESSONS = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "4 — Verify production env vars: ADMIN/PM_PASSWORD, HMAC_SECRET, CORS, MONGO, BACKUP_EMAIL_TO, RESEND_API_KEY, AUTO_EMAIL_REPORTS, RATE_LIMITING.",
        ...
        "steps_es": [
            ...
            "4 — Verifique env: ADMIN/PM_PASSWORD, HMAC_SECRET, CORS, MONGO, BACKUP_EMAIL_TO, RESEND_API_KEY, AUTO_EMAIL_REPORTS, RATE_LIMITING.",
    ...
    },
    {
        ...
        "steps": [
            "Passwords in env vars: ADMIN_PASSWORD, PM_PASSWORD.",
    ...
    },
    {
        ...
        "why": "Admin owns the HR roster. Add/remove HR personnel, issue temp passwords, disable accounts. HR users only see HR-scoped data.",
        "why_es": "Admin gestiona el roster HR. Agrega/quita personal, emite contraseñas, deshabilita. HR solo ve datos con alcance HR.",
        "steps": [
            "Admin Console → 'HR Users & Logins' panel (purple, between Shop Users and Auto-Email Routing).",
            "Add User: name + email + phone + role. Welcome email goes out automatically via Resend.",
            "Issue/Reset Password: key icon → Email / Show on Screen / Custom password.",
            "Disable / Re-enable: click active/disabled badge to toggle. Disabled accounts can't log in immediately.",
            "Edit / Delete: pencil + trash icons.",
        ],
        "steps_es": [
            "Consola Admin → 'Usuarios y Accesos de RRHH' (morado, entre Taller y Auto-Ruteo).",
            "Agregar: nombre + email + tel + rol. Correo de bienvenida automático.",
            "Resetear contraseña: llave → Email / Mostrar / Personalizada.",
            "Deshabilitar / habilitar: clic en insignia. Bloquea tokens al instante.",
            "Editar / borrar: lápiz + basurero.",
        ],
        "tips": ["Resetting a password invalidates all old HR tokens immediately.", "Seed user hrmanager@mascigc.com needs a password issued before first login."],
        "tips_es": ["Resetear contraseña invalida todos los tokens HR viejos al instante.", "Usuario semilla hrmanager@mascigc.com necesita contraseña emitida primero."],
        "cheatSheet": ["Add · Reset · Disable · Delete.", "Password rotation invalidates tokens."],
        "cheatSheet_es": ["Agregar · Resetear · Deshabilitar · Borrar.", "Rotación invalida tokens."],
    },
    {
        "slug": "admin-12-terminations",
        "order": 12,
        "title": "Lesson 12 — Employee Terminations Dashboard",
        "title_es": "Lección 12 — Tablero de Terminaciones",
        "why": "Dedicated HR dashboard with rehire-eligibility filters, outstanding-equipment status, law-enforcement flags, refusal-to-sign / not-present audit trail. Replaces the old Supervisor Notes tile.",
        "why_es": "Tablero HR dedicado con filtros de recontratación, equipo pendiente, banderas de policía, rechazo/ausente. Reemplaza Notas del Supervisor.",
        "steps": [
            "Admin Console → Employee Terminations callout → /admin/terminations.",
            "5-stat strip: Total · Rehire Yes / No · Outstanding Equip · Law Enforcement.",
            "Search + 4 rehire-eligibility chips: All / Yes / No / Conditional.",
            "Table columns: Date · Employee · Supervisor · Job · Separation Type · Rehire · Flags · View.",
            "View → full FL record drawer + PDF.",
        ],
        "steps_es": [
            "Consola Admin → mosaico Terminaciones → /admin/terminations.",
            "Tira de 5: Total · Recontratar Sí/No · Equipo Pendiente · Policía.",
            "Búsqueda + 4 chips: Todas / Sí / No / Condicional.",
            "Columnas: Fecha · Empleado · Supervisor · Trabajo · Tipo · Recontratar · Banderas · Ver.",
            "Ver → cajón completo + PDF.",
        ],
        "tips": ["Admin-only dashboard. HR sees terminations in their FL Records list.", "Outstanding equipment count updates live from the equipment_checkout collection."],
        "tips_es": ["Tablero solo-admin. HR las ve en su lista de Registros LC.", "Conteo de equipo pendiente se actualiza en vivo."],
        "cheatSheet": ["/admin/terminations · 4 rehire filter chips.", "Flags: outstanding · law · refused · absent."],
        "cheatSheet_es": ["/admin/terminations · 4 chips.", "Banderas: pendiente · policía · rechazó · ausente."],
    },
    {
        ...
        "why": "Site-wide alerts: 9 preloaded templates, 4 severity tiers, optional ack hard-gate, auto-Spanish translation, audit trail, PDF/CSV export, clone/re-broadcast, archive toggle.",
        "why_es": "Alertas a nivel sitio: 9 plantillas, 4 severidades, reconocimiento obligatorio, auto-español, trazabilidad, exportación PDF/CSV, clonar, archivo.",
        "steps": [
            "Admin Console → 'Hub Banner Messages' panel below Compliance Export.",
            "Template chips → auto-fill title + body + severity. Or write from scratch.",
            "Severity: INFO/NOTICE/WARNING/CRITICAL. CRITICAL hard-gates pages until acknowledged.",
            "Optional Expiration. 'Show archived' toggle reveals expired banners.",
            "Require Acknowledgment → full-screen modal until tapped.",
            "Auto-Spanish: 'Preview Spanish' before posting. Claude Haiku 4.5.",
            "Row icons: Clock=Audit · Copy=Clone · Pencil=Edit · Trash=Delete.",
            "Audit dialog → Export PDF or CSV.",
        ],
        "steps_es": [
            "Consola Admin → panel 'Mensajes de Banner' debajo de Exportación de Cumplimiento.",
            "Chips de plantilla → autocompletan título + cuerpo + severidad.",
            "Severidad: INFO/AVISO/ADVERTENCIA/CRÍTICO. CRÍTICO bloquea hasta reconocer.",
            "Expiración opcional. 'Mostrar archivados' revela expirados.",
            "Reconocimiento Obligatorio → modal pantalla completa.",
            "Auto-Español: 'Vista previa en español' antes de publicar.",
            "Iconos: Reloj=Trazabilidad · Copiar=Clonar · Lápiz=Editar · Basura=Borrar.",
            "Trazabilidad → Exportar PDF o CSV.",
        ],
        "tips": ["OSHA visits / stand-downs — use Require Acknowledgment. Pull audit PDF as legal cover.", "Banners poll every 60 sec — posted at 10:00 appear by 10:01."],
        "tips_es": ["Visitas OSHA / paros — use Reconocimiento Obligatorio. Saque PDF como respaldo.", "Banners se actualizan cada 60 seg — 10:00 aparece 10:01."],
        "cheatSheet": ["9 templates · 4 severity · auto-Spanish.", "Require Ack = full-screen modal.", "Audit PDF/CSV · Clone re-broadcasts."],
        "cheatSheet_es": ["9 plantillas · 4 severidades · auto-español.", "Reconocimiento = modal.", "PDF/CSV · Clonar rebroadcast."],
    },
    {
        "slug": "admin-14-cloud-archives",
        "order": 14,
        "title": "Lesson 14 — Cloud Archives (Cloudflare R2)",
        "title_es": "Lección 14 — Archivos en la Nube (R2)",
        "why": "Complete-system nightly archives upload to Cloudflare R2 at 03:00 UTC. Standalone zip — restore the whole Hub even if R2 is unreachable.",
        "why_es": "Archivos completos cada noche a 03:00 UTC. Zip autónomo — restaura todo aún si R2 cae.",
        "steps": [
            "Admin Console → 'Cloud Archives · Cloudflare R2' panel below Stored Backups.",
            "'Build complete archive now' → ~40 sec for typical dataset. Polls every 4 sec.",
            "Nightly schedule strip shows next 03:00 UTC slot + last successful date.",
            "Archive list newest first, with 7-day Cloudflare presigned URLs.",
            "Heartbeat emails embed the latest R2 link automatically.",
            "If R2 not configured, amber notice explains which env vars are missing.",
        ],
        "steps_es": [
            "Consola Admin → panel 'Archivos en la Nube · R2' debajo de Respaldos.",
            "'Construir archivo ahora' → ~40 seg típico. Polling cada 4 seg.",
            "Tira nocturna muestra siguiente 03:00 UTC + última fecha exitosa.",
            "Lista nuevos primero, URLs presignadas 7 días.",
            "Correos heartbeat embeben último link R2 automático.",
            "Si R2 no configurado, aviso ámbar explica env vars faltantes.",
        ],
        "tips": ["R2 cost ≈ <$0.01/mo. Egress free within Cloudflare.", "IT pull: presigned URL OR Cloudflare R2 read-only token direct to bucket."],
        "tips_es": ["Costo R2 ≈ <$0.01/mes. Egress gratis dentro de Cloudflare.", "Pull IT: URL presignada O token R2 read-only directo al bucket."],
        "cheatSheet": ["Build now → zip in 40 sec.", "Nightly 03:00 UTC. Heartbeat embeds link.", "7-day URLs safe for IT."],
        "cheatSheet_es": ["Construir ahora → zip en 40 seg.", "Nocturno 03:00 UTC. Heartbeat embebe link.", "URLs 7 días seguras para IT."],
    },
]
...
HR_LESSONS = [
    {
        ...
        "why": "HR is an isolated, read-only scope. HR sees employee records and payroll data — never PM/financial surfaces. Admin tokens do NOT satisfy HR routes.",
        "why_es": "RRHH es alcance aislado y solo-lectura. Sin superficies PM/financieras. Tokens admin NO funcionan en HR.",
        "steps": [
            "Open /hr/login (or click the HR Portal card on the public Hub).",
            "Sign in with email + password. First-time → Change Password gate.",
            "HR Hub: 5 tiles — Field Leadership Records · Employee Accountability · Time Verification · Payroll Variance · Training Records.",
            "Sign out top right. Sessions auto-clear when you navigate off /hr.",
            "EN/ES toggle in the header.",
        ],
        "steps_es": [
            "Abra /hr/login (o tarjeta HR del Hub público).",
            "Ingrese con correo + contraseña. Primera vez → Cambiar Contraseña.",
            "Hub HR: 5 mosaicos — Registros LC · Responsabilidad · Verificación · Variación · Capacitación.",
            "Salir arriba derecha. Sesiones se limpian al salir de /hr.",
            "EN/ES en encabezado.",
        ],
        "tips": ["Forgot? 30-min reset email via 'Forgot password?'.", "Token wipes when you leave /hr/* — intentional."],
        "tips_es": ["¿Olvidó? Correo de reseteo 30 min.", "Token borra al salir de /hr/* — intencional."],
        "cheatSheet": ["/hr/login · 5 tiles · read-only.", "Sessions clear on /hr/* exit."],
        "cheatSheet_es": ["/hr/login · 5 mosaicos · solo lectura.", "Sesión se borra al salir."],
    },
    {
        "slug": "hr-02-field-leadership-records",
        "order": 2,
        "title": "Lesson 2 — Field Leadership Records (Read-Only)",
        "title_es": "Lección 2 — Registros de Liderazgo (Solo Lectura)",
        "why": "Every write-up, coaching, recognition, evaluation, termination, equipment checkout filed by supervisors — visible here for offboarding clearance and dispute resolution.",
        "why_es": "Cada amonestación, coaching, reconocimiento, evaluación, terminación, entrega de equipo — visible para limpieza de salida y disputas.",
        "steps": [
            "HR Hub → Field Leadership Records.",
            "Search by employee / supervisor / project number.",
            "Form Kind dropdown filters to one type.",
            "Eye icon = detail drawer · PDF icon = official MASCI PDF.",
        ],
        "steps_es": [
            "Hub HR → Registros LC.",
            "Buscar por empleado / supervisor / proyecto.",
            "Dropdown Tipo filtra a uno.",
            "Ojo = detalle · PDF = oficial.",
        ],
        "tips": ["Terminations have dedicated Admin dashboard — ask Admin.", "Photos stream from R2 — not cached on your device."],
        "tips_es": ["Terminaciones tienen tablero Admin propio.", "Fotos vienen de R2 — no se guardan local."],
        "cheatSheet": ["Search/filter · Eye = detail · PDF = download."],
        "cheatSheet_es": ["Buscar/filtrar · Ojo = detalle · PDF = descarga."],
    },
    {
        "slug": "hr-03-employee-accountability",
        "order": 3,
        "title": "Lesson 3 — Employee Accountability (Offboarding Clearance)",
        "title_es": "Lección 3 — Responsabilidad (Limpieza de Salida)",
        "why": "Before offboarding you need the consolidated picture: outstanding equipment, active write-ups, training. This page gives the answer in one search.",
        "why_es": "Antes de salida necesita el panorama: equipo pendiente, amonestaciones activas, capacitación. Una búsqueda.",
        "steps": [
            "HR Hub → Employee Accountability.",
            "Type ≥2 chars of the name → Search.",
            "Stats: FL records · Active write-ups · Outstanding equipment · Trainings.",
            "TERMINATED badge if a termination is already on file.",
            "RED Outstanding Equipment table = must be recovered before offboarding.",
            "FL Records + Training tables below.",
        ],
        "steps_es": [
            "Hub HR → Responsabilidad.",
            "Escriba ≥2 chars → Buscar.",
            "Estadísticas: registros · amonestaciones · equipo · capacitaciones.",
            "Insignia TERMINATED si ya hay terminación.",
            "Tabla ROJA Equipo Pendiente = recuperar antes de salida.",
            "Tablas LC + Capacitación debajo.",
        ],
        "tips": ["Use by-kind chip strip for triage.", "Equipment cleared by filing a Return form in Field Leadership."],
        "tips_es": ["Use chips por-tipo para triaje.", "Equipo se limpia al filar Retorno en Liderazgo."],
        "cheatSheet": ["Search → counts + 3 tables.", "RED table = block offboarding until cleared."],
        "cheatSheet_es": ["Buscar → conteos + 3 tablas.", "Tabla ROJA = bloquea salida."],
    },
    {
        ...
        "why": "Supervisor-reported MASCI crew hours rolled up by employee + week for payroll cross-check. Reads from daily_reports.masci_crews.",
        "why_es": "Horas MASCI reportadas por supervisores consolidadas por empleado + semana para cruzar con nómina.",
        "steps": [
            "HR Hub → Time Verification.",
            "Week Ending default today (Mon–Sun window).",
            "Filters: Employee · Project # · Supervisor.",
            "Stats: Total Employees · Hours · Regular · Overtime (amber if >0).",
            "Toggle Weekly Rollup vs. Per-Day Detail.",
            "Red 'No Lunch' flag = 6+ hr day with no recorded lunch.",
            "FileDown icon = CSV export.",
        ],
        "steps_es": [
            "Hub HR → Verificación de Tiempo.",
            "Fin de Semana default hoy (Lun–Dom).",
            "Filtros: Empleado · Proyecto · Supervisor.",
            "Estadísticas: Empleados · Horas · Regular · OT (ámbar si >0).",
            "Alterne Semanal vs. Por-Día.",
            "Bandera roja Sin-Almuerzo = 6+ hr sin almuerzo.",
            "Icono descarga = CSV.",
        ],
        "tips": ["Reg vs OT = Florida standard (>8 hr/day = OT). Admin can change.", "Notes/photos/materials stripped — payroll-only fields."],
        "tips_es": ["Reg vs OT = estándar Florida (>8 hr/día = OT).", "Notas/fotos/materiales omitidos — solo nómina."],
        "cheatSheet": ["Mon-Sun rolls up. Weekly vs Per-Day toggle.", "No-Lunch flag = 6+ hr no break."],
        "cheatSheet_es": ["Lun-Dom consolida. Semanal vs Por-Día.", "Sin-Almuerzo = 6+ hr sin descanso."],
    },
    {
        "slug": "hr-05-payroll-variance",
        "order": 5,
        "title": "Lesson 5 — Payroll Variance (Exact CSV Diff)",
        "title_es": "Lección 5 — Variación de Nómina (Diff Exact)",
        "why": "Bridges Time Verification and Exact payroll. Paste Exact CSV → matches by employee+week → flags every variance ≥ 15 minutes. Approve / dispute each row.",
        "why_es": "Puente entre Verificación y Exact. Pegue CSV → empareja → marca ≥ 15 min. Apruebe/dispute.",
        "steps": [
            "HR Hub → Payroll Variance.",
            "Set Week Ending. Optional: change Threshold (minutes).",
            "Paste Exact CSV. Required: Employee Name + Regular OR Total Hours.",
            "Run Variance → batch created.",
            "Colors: GREEN match · AMBER minor · RED flag · ROSE missing-from-payroll.",
            "Approve / Dispute per row — persists immediately.",
            "CSV download for Exact reimport / finance.",
        ],
        "steps_es": [
            "Hub HR → Variación de Nómina.",
            "Fije Fin de Semana. Opcional: ajuste Umbral.",
            "Pegue CSV Exact. Requerido: Nombre + Reg O Total.",
            "Ejecutar → lote creado.",
            "Colores: VERDE match · ÁMBAR menor · ROJO marcado · ROSA falta.",
            "Aprobar / Disputar — persiste al instante.",
            "Descarga CSV para Exact / finanzas.",
        ],
        "tips": ["Matching = last:first-initial. Spelling mismatches show Unmatched.", "ROSE = paid in field but missing in Exact. Usually missing ID.", "Weekly email Sunday 18:00 UTC to hrmanager@ + jaymn.judd@."],
        "tips_es": ["Empareja apellido:inicial. Diferencias = No-Emparejado.", "ROSA = pagado en campo pero falta en Exact. ID faltante.", "Correo semanal domingo 18:00 UTC."],
        "cheatSheet": ["Paste → Run → Approve/Dispute.", "GREEN/AMBER/RED/ROSE.", "Auto-email Sun 18:00 UTC."],
        "cheatSheet_es": ["Pegar → Ejecutar → Aprobar/Disputar.", "VERDE/ÁMBAR/ROJO/ROSA.", "Auto-correo Dom 18:00 UTC."],
    },
    {
        ...
        "why": "Tracks completed Training Hub lessons per employee. Required for OSHA recordkeeping. Read-only — auto-populated by Training Hub completions.",
        "why_es": "Sigue lecciones completadas. Requerido para OSHA. Solo-lectura — automático.",
        "steps": [
            "HR Hub → Training Records.",
            "Filter by Employee. Apply.",
            "Columns: Employee · Track · Completed · Score.",
            "Empty state when collection is empty (new install).",
        ],
        "steps_es": [
            "Hub HR → Registros de Capacitación.",
            "Filtre por Empleado. Apply.",
            "Columnas: Empleado · Track · Completado · Puntaje.",
            "Estado vacío al inicio.",
        ],
        "tips": ["Ask Admin to check the Training Hub recorder if an employee shows zero."],
        "tips_es": ["Pida Admin revisar grabador si muestra cero."],
        "cheatSheet": ["Filter by employee. Auto-populated."],
        "cheatSheet_es": ["Filtre por empleado. Automático."],
    },
    {
        "slug": "hr-07-offboarding-workflow",
        "order": 7,
        "title": "Lesson 7 — End-to-End Offboarding Workflow",
        "title_es": "Lección 7 — Flujo Completo de Limpieza de Salida",
        "why": "Exact sequence HR follows when an employee leaves — termination → accountability → equipment recovery → time verification → variance → archive.",
        "why_es": "Secuencia exacta al partir un empleado — terminación → responsabilidad → equipo → tiempo → variación → archivar.",
        "steps": [
            "1. Supervisor files Termination → Admin email + /admin/terminations.",
            "2. HR Hub → Employee Accountability → search name → review counts.",
            "3. If Outstanding Equipment exists: contact supervisor to file Equipment Return per item.",
            "4. HR Hub → Time Verification → narrow to final week → confirm hours.",
            "5. HR Hub → Payroll Variance → upload Exact CSV → approve/dispute.",
            "6. Archive Termination PDF (HR Hub → Field Leadership → row PDF) in personnel file.",
        ],
        "steps_es": [
            "1. Supervisor filea Terminación → correo Admin + /admin/terminations.",
            "2. Hub HR → Responsabilidad → buscar nombre.",
            "3. Si hay Equipo Pendiente: pedir supervisor filar Retorno por cada item.",
            "4. Hub HR → Verificación → última semana → confirmar horas.",
            "5. Hub HR → Variación → subir CSV Exact → aprobar/disputar.",
            "6. Archivar PDF Terminación en archivo del empleado.",
        ],
        "tips": ["Never skip Step 3. Outstanding equipment is the #1 post-offboarding dispute source."],
        "tips_es": ["Nunca omita Paso 3. Equipo pendiente es la fuente #1 de disputas post-salida."],
        "cheatSheet": ["1.Term → 2.Acct → 3.Equip → 4.Hours → 5.Variance → 6.Archive."],
        "cheatSheet_es": ["1.Term → 2.Resp → 3.Equipo → 4.Horas → 5.Variación → 6.Archivar."],
    },
    {
        "slug": "hr-08-your-account",
        "order": 8,
        "title": "Lesson 8 — Your HR Account & Password",
        "title_es": "Lección 8 — Su Cuenta y Contraseña HR",
        "why": "How your HR account works — creation, first-login change, manual change, forgot-password, lockout recovery.",
        "why_es": "Cómo funciona su cuenta — creación, primer cambio, cambio manual, olvido, recuperación.",
        "steps": [
            "Account created by Admin. Welcome email with temp pw.",
            "First login → Change Password (8+ chars).",
            "Manual change anytime: /hr/change-password.",
            "Forgot? /hr/login → 'Forgot password?' → 30-min reset email.",
            "Locked out? Contact Admin to re-enable.",
        ],
        "steps_es": [
            "Cuenta creada por Admin. Correo bienvenida con temp.",
            "Primer ingreso → Cambiar Contraseña (8+).",
            "Cambio manual: /hr/change-password.",
            "¿Olvidó? /hr/login → 'Olvidó?' → correo 30 min.",
            "¿Bloqueado? Admin re-habilita.",
        ],
        "tips": ["Token rotation logs you out on every other device. Re-sign-in there.", "Use a long memorable phrase, not Password1!"],
        "tips_es": ["Rotación de token cierra otras sesiones. Re-ingrese.", "Use frase memorable larga."],
        "cheatSheet": ["Welcome → Change Password → in.", "Forgot? Self-service reset.", "Locked? Admin re-enables."],
        "cheatSheet_es": ["Bienvenida → Cambiar → adentro.", "¿Olvidó? Auto-reseteo.", "¿Bloqueado? Admin."],
    },
]


LESSONS = FIELD_LESSONS + SHOP_LESSONS + PM_LESSONS + ADMIN_LESSONS + HR_LESSONS
...
_STRINGS = {
    "en": {
        ...
        "page": "Page",
        "of": "of",
        "footer_legal": "Generated through MASCI Operations Platform \u2014 Powered by ForgedOps\u2122 | \u00a9 2026 ForgedOps\u2122",
    ...
    "es": {
        ...
        "page": "Página",
        "of": "de",
        "footer_legal": "Generado a trav\u00e9s de MASCI Operations Platform \u2014 Desarrollado por ForgedOps\u2122 | \u00a9 2026 ForgedOps\u2122",
...
def _css_for_lang(lang: str) -> str:
    ...
    """
    footer_en = "Generated through MASCI Operations Platform \u2014 Powered by ForgedOps\u2122 | \u00a9 2026 ForgedOps\u2122"
    footer_es = "Generado a trav\u00e9s de MASCI Operations Platform \u2014 Desarrollado por ForgedOps\u2122 | \u00a9 2026 ForgedOps\u2122"
